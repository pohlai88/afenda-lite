...
/** Observability + reliance action labels for draft Route Handler. */
export const GET_CLIENT_DECLARATION_DRAFT_API_ACTION =
  "getClientDeclarationDraftApi" as const;
export const WRITE_CLIENT_DECLARATION_DRAFT_API_ACTION =
  "writeClientDeclarationDraftApi" as const;

/** @deprecated Prefer WRITE_CLIENT_DECLARATION_DRAFT_API_ACTION */
...
export const API_ROUTE_ACTION_IDS = {
  CLIENT_DECLARATION_DRAFT_API_HREF: `action:${WRITE_CLIENT_DECLARATION_DRAFT_API_ACTION}`,
} as const satisfies Record<"CLIENT_DECLARATION_DRAFT_API_HREF", `action:${string}`>;
