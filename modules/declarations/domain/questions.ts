...
import { validateEvidenceMetadata } from "@/modules/declarations/domain/evidence-policy";
import type {
  EvidenceRecord,
  QuestionType,
  SurveyAnswers,
...
import { questionConfigSchema } from "@/modules/declarations/schemas/questions";
import { formStringDefault } from "@/modules/declarations/server-actions/form-data";
...
export function parseQuestionsFromForm(formData: FormData) {
  ...
  const configsRaw = formStringDefault(formData, "questionConfigs", "[]");
