import { z } from "zod";
import { CLIENT_ONBOARDING, CLIENT_INVITE } from "@/modules/platform/form-constraints";
import { ISO_COUNTRY_CODES } from "@/modules/declarations/countries";
import {
  emailSchema,
  slugSchema,
  surveyAnswersSchema,
...
/** Query for `GET /api/client/declaration-draft?assignmentId=` */
export const getClientDeclarationDraftQuerySchema = z.object({
  assignmentId: uuidSchema,
});
