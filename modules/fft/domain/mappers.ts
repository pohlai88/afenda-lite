...
export function mapEventRow(row: EventRow): FftEvent {
  return {
    id: row.id,
    ...
    status: row.status as FftEvent["status"],
...
export function mapProductRow(row: ProductRow): FftProduct {
  return {
    id: row.id,
...
export function mapFieldDefRow(row: FieldDefRow): FftFieldDef {
  return {
    id: row.id,
    eventId: row.event_id,
    entityType: row.entity_type,
    fieldKey: row.field_key,
    fieldType: row.field_type as FftFieldType,
...
export function mapOrderRow(row: OrderRow): FftOrder {
  return {
    id: row.id,
    eventId: row.event_id,
    ...
    status: row.status as FftOrder["status"],
    depositStatus: row.deposit_status as FftOrder["depositStatus"],
    pickupStatus: row.pickup_status,
    transferStatus: row.transfer_status as FftOrder["transferStatus"],
...
export function mapPriorityRow(row: PriorityRow): FftCustomerPriority {
  return {
    id: row.id,
    eventId: row.event_id,
    customerName: row.customer_name,
...
export function mapSalesMemberRow(row: SalesMemberRow): FftSalesMember {
  return {
    id: row.id,
    userId: row.user_id,
    email: row.email,
...
export function mapAllocationRunRow(row: AllocationRunRow): FftAllocationRun {
  return {
    id: row.id,
    eventId: row.event_id,
    runBy: row.run_by,
    runAt: row.run_at,
    mode: row.mode as FftAllocationRun["mode"],
    reason: row.reason,
...
export function resolvePriorityForCustomer(
  priorities: FftCustomerPriority[],
