/**
 * Pure Feed Farm Trade RBAC guards (ADR-001 / Phase 2A).
...
export function assignmentScopeMatches(
  assignment: Pick<FftRoleAssignment, "scopeType" | "scopeId" | "active">,
  actorUserId: string,
  ctx: FftScopeContext = {},
...
export function collectEffectivePermissionCodes(
  actorUserId: string,
  assignments: readonly FftRoleAssignment[],
  ctx: FftScopeContext = {},
): Set<string> {
