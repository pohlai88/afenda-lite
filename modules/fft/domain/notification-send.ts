...
} from "@/modules/fft/domain/notification-store";
import {
  buildNotificationIdempotencyKey,
  markdownToHtml,
  renderNotificationTemplate,
} from "@/modules/fft/domain/notification-render";
import type {
...
/**
 * Fire-and-forget Feed Farm Trade mail (ADR-003).
...
export function notifyFftEvent(input: SendTradeNotificationInput): void {
