import type { FftEvent, FftOrder, FftProduct } from "@/modules/fft/domain/types";
...
export function canCompleteOrder(
  order: Pick<FftOrder, "fulfilledQuantity" | "status">,
...
export function calculateSupportForOrder(
  order: Pick<FftOrder, "confirmedQuantity" | "fulfilledQuantity" | "status">,
  product: FftProduct,
  event: FftEvent,
