...
import { createHttpRestErpAdapter } from "@/modules/trade/domain/erp/http-rest/adapter";
import { noopErpAdapter } from "@/modules/trade/domain/erp/generic-noop";
import type { ErpAdapter } from "@/modules/trade/domain/erp/types";
import { isRegisteredErpVendor } from "@/modules/trade/domain/erp/vendors";
