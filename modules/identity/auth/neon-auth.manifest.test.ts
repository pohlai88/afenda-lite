...
import manifest from "@/modules/identity/auth/neon-auth.manifest.json";
import {
  assertNeonAuthManifestMatchesEnv,
  getNeonAuthManifest,
} from "@/modules/identity/auth/neon-auth.manifest";
import {
  neonAuthUiAccount,
  neonAuthUiFeatures,
...
} from "@/modules/identity/auth/neon-auth-ui.config";
import { neonAuthSocialConfigFromManifest } from "@/modules/identity/auth/neon-auth-oauth";
