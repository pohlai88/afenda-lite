...
} from "@/lib/pages/organization-admin-declaration-detail.logic";
...
export type { OperatorDeclarationQuestionDraft } from "@/lib/pages/organization-admin-declaration-detail.logic";
export {
  collectSubmissionFileEvidenceIds,
  mapOperatorDeclarationQuestionDrafts,
} from "@/lib/pages/organization-admin-declaration-detail.logic";
