...
export const DOMAIN_MODULE_DEFINITIONS: ReadonlyArray<{
  ...
  { id: "domain:surveys", label: "Surveys", path: "lib/surveys.ts" },
  { id: "domain:questions", label: "Questions", path: "lib/questions.ts" },
  { id: "domain:clients", label: "Clients", path: "lib/clients.ts" },
  { id: "domain:audit", label: "Audit", path: "lib/audit.ts" },
  { id: "domain:auth", label: "Auth", path: "lib/auth/" },
  { id: "domain:email", label: "Email", path: "lib/email/" },
  { id: "domain:survey-package", label: "Survey package", path: "lib/survey-package.ts" },
  { id: "domain:client-onboarding", label: "Client onboarding", path: "lib/client-onboarding.server.ts" },
  { id: "domain:client-invitation-entry", label: "Invitation entry", path: "lib/client-invitation-entry.ts" },
  { id: "domain:open-link-entry", label: "Open link entry", path: "lib/open-link-entry.ts" },
...
/** Surfaces checked by validate-ui-sync.mjs (DB + fixture materialization). */
