...
const e2eAssertions: Record<string, RegExp> = {
  ...
  "hot-sales-trade-index": /trade|events|sign in|declaration workspace/i,
  "hot-sales-events": /event|trade|sign in|declaration workspace/i,
  "hot-sales-my-orders": /order|trade|sign in|declaration workspace/i,
  "hot-sales-event-order": /order|trade|sign in|declaration workspace/i,
  "hot-sales-admin-events": /event|admin|trade|sign in|declaration workspace/i,
  "hot-sales-admin-events-new": /event|admin|trade|sign in|declaration workspace/i,
  "hot-sales-admin-event-setup": /setup|event|trade|sign in|declaration workspace/i,
  "hot-sales-admin-event-allocation": /allocation|event|trade|sign in|declaration workspace/i,
  "hot-sales-admin-event-deposits": /deposit|event|trade|sign in|declaration workspace/i,
  "hot-sales-admin-event-imports": /import|event|trade|sign in|declaration workspace/i,
  "hot-sales-admin-event-pickup": /pickup|event|trade|sign in|declaration workspace/i,
  "hot-sales-admin-erp-sync": /erp|sync|trade|sign in|declaration workspace/i,
  "hot-sales-admin-rbac": /rbac|role|trade|sign in|declaration workspace/i,
};
