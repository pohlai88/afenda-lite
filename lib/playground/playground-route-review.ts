...
export const playgroundRouteReviewById = {
  ...
  "client-named-login": redirectEntry(
    ...
    ["app/client/(gate)/login/page.tsx", "lib/entry/client-sign-in-entry.ts"],
    [
      {
        label: "Authenticated normal navigation",
        outcome: "redirect",
  ...
  "client-org-login": redirectEntry(
    ...
    ["app/org/login/page.tsx", "lib/entry/org-sign-in-entry.ts"],
    [
      {
        label: "Authenticated normal navigation",
        outcome: "redirect",
  ...
  "client-auth-admin-legacy": redirectEntry(
    ...
    ["/auth/sign-in?from=org"],
    ["app/auth/admin/page.tsx", "lib/entry/org-sign-in-entry.ts"],
  ),
  ...
  "dynamic-auth-accept-invitation": redirectEntry(
    ...
    ["app/auth/[path]/page.tsx", "lib/entry/client-invitation-entry.ts"],
    [
      {
        label: "invitationId query",
        outcome: "redirect",
  ...
  "dynamic-public-survey-slug": redirectOrNotFoundEntry(
    ...
    ["app/survey/[slug]/page.tsx", "lib/entry/open-link-entry.ts"],
  ),
  "dynamic-public-secure-token": redirectOrNotFoundEntry(
    ...
    ["/auth/sign-in?returnTo=…", "/client/declare/…"],
    ["app/f/[token]/page.tsx", "lib/entry/secure-link-entry.ts"],
  ),
  "dynamic-legacy-invite-token": redirectEntry(
    ...
    ["app/invite/[token]/page.tsx", "lib/entry/legacy-invite-entry.ts"],
  ),
  "dynamic-client-join": placeholder(
    "Canonical Neon organization invitation entry.",
    ["app/join/page.tsx", "lib/entry/client-invitation-entry.ts", "doc/frontend/10-join-phase2-tasks.md"],
    {
      label:
