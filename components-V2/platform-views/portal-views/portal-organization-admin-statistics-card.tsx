...
export type PortalOrganizationAdminStatisticsCardProps = {
  icon: ReactElement
  title: string
  description: string
  value: string
...
export default function PortalOrganizationAdminStatisticsCard({
  icon,
  title,
  description,
  value,
  className,
  iconClassName
}: PortalOrganizationAdminStatisticsCardProps) {
  return (
