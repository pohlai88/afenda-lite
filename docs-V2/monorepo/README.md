...
| Companion | [Generator architecture PRD](generator-architecture-prd.md) · [G1 ERP manifest authority contract](g1-erp-manifest-authority-contract.md) · [G2 ERP layout convergence contract](g2-erp-layout-convergence-contract.md) · [G3 ERP projection lock contract](g3-erp-projection-lock-contract.md) · [G4 explicit ERP spec contract](g4-explicit-erp-spec-contract.md) · [G5 versioned treatment/recovery contract](g5-versioned-treatment-recovery-contract.md) · [G6 kernel package adoption contract](g6-kernel-package-adoption-contract.md) · [G7 repo documentation/governance convergence contract](g7-repo-documentation-governance-convergence-contract.md) · [G8 generator phase-exit convergence contract](g8-generator-phase-exit-convergence-contract.md) · [G9 read-only reconciliation planner contract](g9-read-only-reconciliation-planner-contract.md) · [G10 explicit ERP create package contract](g10-explicit-erp-create-package-contract.md) · [G11 explicit ERP add feature contract](g11-explicit-erp-add-feature-contract.md) · [G12 ERP projection lock apply contract](g12-erp-projection-lock-apply-contract.md) · [G13 kernel adoption apply contract](g13-kernel-adoption-apply-contract.md) · [G14 generator transaction safety contract](g14-generator-transaction-safety-contract.md) · [G15 local generator closure governance contract](g15-local-generator-closure-governance-contract.md) · [G16 local generator command catalog contract](g16-local-generator-command-catalog-contract.md) · [G17 generator stop boundary contract](g17-generator-stop-boundary-contract.md) · [LAYERS.md](../../.cursor/skills/afenda-elite-monorepo-discipline/LAYERS.md) · [packages/README.md](../../packages/README.md) · [WORKSPACE-EDGE-REGISTER.yaml](../modules/WORKSPACE-EDGE-REGISTER.yaml) |
