...
> **Historical evidence notice (2026-07-26):** The 176/177/179 tenancy totals below are dated migration checkpoints from 2026-07-24. They do not describe current inventory. Current disk authority contains **274** hard-tenant roots, including **141 `hr_*`** roots, with executable-audit parity enforced by the DB tenancy test.
