...
> **Historical snapshot notice (2026-07-26):** Counts and command/test results in this audit are evidence from 2026-07-24. Current hard-tenant inventory is **141 `hr_*` roots** within **274** repository roots. Current authority: the HR package README, module manifest, and `hard-tenant-roots.ts`.
