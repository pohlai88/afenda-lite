...
- [ ] Diff touches only `app/dashboard/**`, `features/organization-admin/**`, portal-views import remaps, V2 ui gaps (`alert-dialog` / `DialogBody`), and `docs/frontend` phase-1 docs
