...
Promotion and flags: follow Feed Farm Trade [gate-register](../fft/ops/gate-register.md) — not this doc. Do **not** restore a separate `FftShell` / locale switcher; chrome is AdminCN only.
