...
| **Build authorization** | **Flag enablement closed** — flags default `false`; enabling in production requires the Feed Farm Trade [gate-register](../fft/ops/gate-register.md) checklist. FE placeholder work described here is scoped, not a promotion authorization. |
...
| **Engine ADRs (source of truth for this phase)** | [002 finance/pickup](../fft/adr/002-finance-deposit-pickup-ops.md) · [003 imports/notifications](../fft/adr/003-imports-notifications.md) · [004 ERP sync](../fft/adr/004-erp-sync.md) |
...
- [docs/fft/RUNTIME.md](../fft/RUNTIME.md) — flags, env defaults, code map (engine SSOT)
- [docs/fft/ops/gate-register.md](../fft/ops/gate-register.md) — promotion checklist
- [docs/fft/adr/002-finance-deposit-pickup-ops.md](../fft/adr/002-finance-deposit-pickup-ops.md)
- [docs/fft/adr/003-imports-notifications.md](../fft/adr/003-imports-notifications.md)
- [docs/fft/adr/004-erp-sync.md](../fft/adr/004-erp-sync.md)
