...
- Explicit user reopen of P2 in this repo (see `AGENTS.md` · `/using-afenda-elite-skills` · [closed-scope-register](../architecture/closed-scope-register.md)) before any code changes — this document alone is not that reopen.
