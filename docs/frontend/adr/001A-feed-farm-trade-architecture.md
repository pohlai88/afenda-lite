...
| REST contract | `docs/api/02-rest-resources.md` | Locale-free `/api/fft/...` — contract-only |
...
- **P3 promotion:** flags + [gate-register](../../fft/ops/gate-register.md) only — do not invent checklists in FE ADRs.
...
- [docs/fft/architecture/s19-trade-slice.md](../../fft/architecture/s19-trade-slice.md) — Phase 1 engine slice (historical)
