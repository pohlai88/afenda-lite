...
| **Pair** | Keep with 001 / 001A under `docs/frontend/adr/` |
...
| **Resolution** | Restored from `f479d5a^`. Living SSOT: [RUNTIME](../../fft/RUNTIME.md) · [gate-register](../../fft/ops/gate-register.md). |
...
- [x] API catalog locale-free for trade (`docs/api/02-rest-resources.md`)
...
**G0 docs restored.** Do not invent promotion checklists here — use [ops/gate-register.md](../../fft/ops/gate-register.md).
