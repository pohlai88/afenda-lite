...
**Playbook:** [docs/architecture/admincn-customization.md](../architecture/admincn-customization.md)  
**Preflight:** [docs/architecture/admincn-frontend-preflight.md](../architecture/admincn-frontend-preflight.md)  
