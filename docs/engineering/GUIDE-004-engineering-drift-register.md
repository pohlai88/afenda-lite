...
| [docs/adr/turborepo/](../adr/turborepo/) ADR-010…014 (Accepted) | Decisions only | Binding for new work; do not reopen without superseding ADR |
...
| `docs/guides/GUIDE-007-organization-admin-phase-1-tasks.md` | `../../app/dashboard/layout.tsx` |
| `docs/guides/GUIDE-007-organization-admin-phase-1-tasks.md` | `../../app/dashboard/error.tsx` |
| `docs/guides/GUIDE-009-join-phase-2-tasks.md` | `../../features/auth/README.md` |
