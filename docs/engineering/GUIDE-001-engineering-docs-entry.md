...
| Feed Farm Trade runtime | [../fft/MOD-001-feed-farm-trade-runtime.md](../modules/feed-farm-trade/MOD-001-feed-farm-trade-runtime.md) |
...
- Keep engineering docs in `docs/engineering/` unless a narrower existing owner fits better.
- Keep decision records in `docs/**/adr/`, not inside a catch-all guide.
- Keep operating procedures in `docs/runbooks/` or `docs/modules/feed-farm-trade/ops/`.
