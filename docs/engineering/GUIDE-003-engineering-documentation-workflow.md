...
|------|-------------|----------|
| Technical spec | Near the owning module docs, usually `docs/architecture/frontend/`, `docs/architecture/backend/`, `docs/modules/feed-farm-trade/spec/`, or `docs/engineering/` | A planned change needs goals, constraints, design, rollout, rollback, and open questions |
| Architecture | `docs/architecture/`, `docs/architecture/backend/`, `docs/architecture/frontend/`, or `docs/modules/feed-farm-trade/architecture/` | A system boundary, component model, or trade-off needs to be explained |
| ADR | `docs/**/adr/` | One material decision needs status, context, alternatives, consequences, and follow-up |
| Runbook | `docs/runbooks/` or `docs/modules/feed-farm-trade/ops/` | Operators need to diagnose, recover, validate, or escalate |
...
| Internal guide | `docs/engineering/` or the owning area | Maintainers need implementation-facing explanation |
...
docs/adr/backend/ADR-002-platform-tenancy-rbac.md
docs/engineering/GUIDE-002-coding-engineering-guide.md
