# ADR-004 Feed Farm Trade Architecture
...
| **Decision locks** | [001-feed-farm-trade.md](ADR-003-feed-farm-trade-module.md) |
| **Roadmap / MVP** | [001R-feed-farm-trade-roadmap.md](ADR-005-feed-farm-trade-roadmap.md) |
...
Feed Farm Trade is the **product** module for B2B feed & farm trade sales. The **engine** remains Feed Farm Trade (`FFT_*`, `docs/modules/feed-farm-trade/`). UI uses the shared AdminCN shell under locale-free `/fft/*`.
...
| Ops SSOT | `docs/modules/feed-farm-trade/` | RUNTIME, gate-register, engine ADRs |
...
- **P3 promotion:** flags + [gate-register](../../modules/feed-farm-trade/ops/RB-002-feed-farm-trade-gate-register.md) only — do not invent checklists in FE ADRs.
- **G0:** `docs/modules/feed-farm-trade/` is present (restored). Cite RUNTIME / gate-register as living authority.
...
- [001-feed-farm-trade.md](ADR-003-feed-farm-trade-module.md) — locks
- [001R-feed-farm-trade-roadmap.md](ADR-005-feed-farm-trade-roadmap.md) — P0–P3 + gaps
- [../01-architecture.md](../../architecture/frontend/ARCH-002-frontend-architecture.md) — portal FE layers
- [../03-routes.md](../../architecture/frontend/ARCH-012-app-router-routes.md) — route table
- [../../architecture/backend/ARCH-006-bounded-contexts.md](../../architecture/backend/ARCH-006-bounded-contexts.md) — Trade context
- [docs/modules/feed-farm-trade/architecture/ARCH-017-feed-farm-trade-event-engine.md](../../modules/feed-farm-trade/architecture/ARCH-017-feed-farm-trade-event-engine.md) — Phase 1 engine slice (historical)
