# ADR-005 Feed Farm Trade Roadmap
...
| **Decision** | [001-feed-farm-trade.md](ADR-003-feed-farm-trade-module.md) |
| **Architecture** | [001A-feed-farm-trade-architecture.md](ADR-004-feed-farm-trade-architecture.md) |
| **Pair** | Keep with 001 / 001A under `docs/architecture/frontend/adr/` |
...
| | |
|--|--|
| **Finding (was)** | Working tree briefly had **no** `docs/modules/feed-farm-trade/` after `f479d5a`. |
| **Resolution** | Restored from `f479d5a^`. Living SSOT: [RUNTIME](../../modules/feed-farm-trade/MOD-001-feed-farm-trade-runtime.md) · [gate-register](../../modules/feed-farm-trade/ops/RB-002-feed-farm-trade-gate-register.md). |
...
**Dev spec + evaluation checklist:** [11-feed-farm-trade-phase0-shell.md](../../guides/GUIDE-010-feed-farm-trade-phase-0-shell.md)
...
**DoD:** [x] layout gate + AdminCN · [x] `resolveShellAccess` + tests · [x] nav `moduleId` · [x] fft-session deny tests · [x] pair in `docs/README.md` · [x] no live `app/fft/[locale]`

---

## P1 — Core cycle (MVP)

**Dev spec + evaluation checklist:** [12-feed-farm-trade-phase1-core-mvp.md](../../guides/GUIDE-011-feed-farm-trade-phase-1-core-mvp.md)
...
- [x] API catalog locale-free for trade (`docs/api/REST-001-rest-resources.md`)
...
**Dev spec:** [13-feed-farm-trade-phase2-ui-polish.md](../../guides/GUIDE-012-feed-farm-trade-phase-2-ui-polish.md)

**P2 complete 2026-07-11** (P2-AC-01..06 PASS in [13](../../guides/GUIDE-012-feed-farm-trade-phase-2-ui-polish.md)). Further polish only with a named P2-AC + Plan for visual. `features/fft` + thin pages; Feed Farm Trade copy; P1 AC stay green; templates as data; no FftShell.

---

## P3 — Ops flags (not MVP)

**Dev spec (scope-only, not authorization):** [14-feed-farm-trade-phase3-ops-flags.md](../../guides/GUIDE-013-feed-farm-trade-phase-3-ops-flags.md)

Deposits / pickup / imports / ERP (`F-OPS-*`) only when `FFT_*` on **and** gate-register allows.

**G0 docs restored.** Do not invent promotion checklists here — use [ops/gate-register.md](../../modules/feed-farm-trade/ops/RB-002-feed-farm-trade-gate-register.md).
