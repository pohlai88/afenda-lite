...
| Public HTTP | One REST catalog (`docs/api`) — extend additively |
...
- [../../architecture/backend/ARCH-004-backend-layers.md](../../architecture/backend/ARCH-004-backend-layers.md)  
