...
| **Namespace** | `docs/adr/` (product identity — not Frontend ADR-001 FFT) |
...
SKIP: FFT module locks → docs/frontend/adr/001* · hexagon → docs/backend/adr/001
```
...
- [docs/frontend/adr/001-feed-farm-trade.md](../frontend/adr/001-feed-farm-trade.md) — FFT module locks
- [docs/backend/03-bounded-contexts.md](../backend/03-bounded-contexts.md) — modules on one platform
