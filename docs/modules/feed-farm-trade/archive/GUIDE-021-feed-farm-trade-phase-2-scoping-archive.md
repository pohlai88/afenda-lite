# GUIDE-021 Feed Farm Trade Phase 2 Scoping Archive
...
**Phase 1 accepted baseline:** commit `1bc1294` · tag `fft-phase-1` · [../spec/phase-1-prd.md](../spec/GUIDE-015-feed-farm-trade-phase-1-prd.md)  
**Vision archive:** [../archive/vision.md](../archive/GUIDE-022-feed-farm-trade-vision-archive.md)  
**Authoritative Phase 2 planning direction:** [./phase-2-feedback.md](./GUIDE-020-feed-farm-trade-phase-2-feedback-archive.md) (adopted 2026-07-09)  
**Build contract draft:** [../spec/phase-2a-prd.md](../spec/GUIDE-016-feed-farm-trade-phase-2a-prd.md) (**Accepted**)  
**RBAC ADR draft:** [../adr/001-rbac.md](../adr/ADR-006-feed-farm-trade-rbac.md) (**Accepted**)  
**Phase 2A slice plan:** [../spec/phase-2a-slices.md](../spec/GUIDE-017-feed-farm-trade-phase-2a-slices.md) (**closed**)  
**Ops gate SSOT:** [../ops/gate-register.md](../ops/RB-002-feed-farm-trade-gate-register.md) (**closed**)

Phase 2A **implementation is closed** (tag `fft-phase-2a` → `8e650ff`). **operational rollout closed** — follow the gate register. Do **not** start 2B–2D from this file.

This file remains as the original **candidate list**. It is **superseded for Phase 2 planning** by [./phase-2-feedback.md](./GUIDE-020-feed-farm-trade-phase-2-feedback-archive.md) and the Accepted PRD/ADR above. Its **sequencing** and **“7-role RBAC” framing** must not be used as the build contract.
...
Phase 1 shipped a reusable Feed Farm Trade event engine under `/fft` (admin + sales allowlist, allocation, deposit/transfer **lite**, CSV export, vi/en). Phase 2 expands toward the full PRD vision without breaking the Phase 1 engine contract (generic events, piglet = template data only).
...
| Original sketch | Map fixed PRD job titles onto Neon Auth / `fft_role` |
| **Superseded by** | Fixed permission catalog + client-customisable roles + default templates + scoped assignments + audit — see [./phase-2-feedback.md](./GUIDE-020-feed-farm-trade-phase-2-feedback-archive.md) Phase 2A |
...
| Open questions | Same `/fft` surface vs `/fft/.../ops`? Mobile-first? |
...
The linear list below is retained for history only. **Use 2A → 2B → 2C → 2D** from [./phase-2-feedback.md](./GUIDE-020-feed-farm-trade-phase-2-feedback-archive.md).
...
- No coupling Feed Farm Trade Phase 2 to `/playground`, declaration domain, or layout/repo-migration WIP
...
1. Follow [../ops/gate-register.md](../ops/RB-002-feed-farm-trade-gate-register.md) — **Gate 4B** sales allowlist is active  
