...
| FFT-AC-001-02 | FFT-MOD-001 | Enterprise Core | CORE-ARCH | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft/auth/fft-session` | 764287d | 2026-07-14 | Product/test tree absent at HEAD (`modules/fft`, `testing/vitest.config.ts` missing) |
| FFT-AC-001-03 | FFT-MOD-001 | Enterprise Core | CORE-ARCH | Core | Enabled | BLOCKED | `npm run test:e2e:smoke` | 764287d | 2026-07-14 | `e2e/` absent at HEAD; boundary journey cannot execute |
| FFT-AC-002-01 | FFT-MOD-002 | Enterprise Core | CORE-PROCESS | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft/domain/trade` · `npm run test:e2e:journey` | 764287d | 2026-07-14 | Domain/journey runners absent at HEAD |
...
| FFT-AC-003-01 | FFT-MOD-003 | Enterprise Core | CORE-PLATFORM | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft` | 764287d | 2026-07-14 | Runtime unit suite cannot load (`testing/vitest.config.ts` unresolved) |
| FFT-AC-003-02 | FFT-MOD-003 | Enterprise Core | CORE-PLATFORM | Core | Enabled | BLOCKED | `npm run env:compose` / manifest cross-check vs live module accessors | 764287d | 2026-07-14 | Module env accessors under `modules/fft` / `lib/env` absent at HEAD; cannot prove compose alignment end-to-end |
| FFT-AC-003-03 | FFT-MOD-003 | Enterprise Core | CORE-PLATFORM | Conditional | Disabled | NOT EVIDENCED | env.config `FFT_ERP_SYNC_ENABLED=false` | 764287d | 2026-07-14 | Flag off alone is not fail-closed runtime evidence without product gate tests |
| FFT-AC-004-01 | FFT-MOD-004 | Enterprise Core | CORE-DATA | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft` · tenancy unit paths | 764287d | 2026-07-14 | Hard-tenancy tests not executable; `modules/fft` / `db` absent at HEAD |
| FFT-AC-004-02 | FFT-MOD-004 | Enterprise Core | CORE-DATA | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft/domain/trade` | 764287d | 2026-07-14 | Concurrency/transaction tests not executable at HEAD |
...
| FFT-AC-005-01 | FFT-MOD-005 | Enterprise Core | CORE-SECURITY | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft/auth/fft-session` · `modules/fft/domain/rbac` | 764287d | 2026-07-14 | Session/RBAC suites absent at HEAD |
| FFT-AC-005-02 | FFT-MOD-005 | Enterprise Core | CORE-SECURITY | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft/domain/access` · e2e deny path | 764287d | 2026-07-14 | Multi-org / deny path tests absent at HEAD |
| FFT-AC-005-03 | FFT-MOD-005 | Enterprise Core | CORE-SECURITY | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft/domain/rbac` (`rbac-audit`) | 764287d | 2026-07-14 | Sensitive-permission audit tests absent at HEAD |
| FFT-AC-005-04 | FFT-MOD-005 | Enterprise Core | CORE-SECURITY | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft/auth` phase gates | 764287d | 2026-07-14 | Abuse/own-scope gate tests absent at HEAD |
| FFT-AC-006-01 | FFT-MOD-006 | Enterprise Core | CORE-EXPERIENCE | Core | Enabled | BLOCKED | `npm run test:interaction -- features/fft` | 764287d | 2026-07-14 | Interaction suite / `features/fft` absent at HEAD |
| FFT-AC-006-02 | FFT-MOD-006 | Enterprise Core | CORE-EXPERIENCE | Core | Enabled | BLOCKED | `npm run check:fft-ui-registry` · journey states | 764287d | 2026-07-14 | `scripts/check-fft-ui-registry.mjs` missing at HEAD (MODULE_NOT_FOUND) |
...
| FFT-AC-007-01 | FFT-MOD-007 | Enterprise Core | CORE-INTEGRATION | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft/domain/trade-action-result` · `trade-action-error-contract` | 764287d | 2026-07-14 | Action/error contract suites absent at HEAD |
| FFT-AC-007-02 | FFT-MOD-007 | Enterprise Core | CORE-INTEGRATION | Core | Enabled | BLOCKED | `npm run test:unit -- modules/fft/domain/trade` | 764287d | 2026-07-14 | Idempotency/domain write suites absent at HEAD |
| FFT-AC-007-03 | FFT-MOD-007 | Enterprise Core | CORE-INTEGRATION | Conditional | Disabled | NOT EVIDENCED | env.config `FFT_ERP_SYNC_ENABLED=false` | 764287d | 2026-07-14 | Disabled ERP sync without executable fail-closed adapter tests remains NOT EVIDENCED |
| FFT-AC-008-01 | FFT-MOD-008 | Enterprise Core | CORE-OPERATIONS | Core | Enabled | BLOCKED | `npm run test:e2e:smoke` · `node scripts/gate-7-production-smoke.mjs` | 764287d | 2026-07-14 | Gate/smoke scripts and e2e absent at HEAD |
| FFT-AC-008-02 | FFT-MOD-008 | Enterprise Core | CORE-OPERATIONS | Core | Enabled | BLOCKED | `npm run audit:fft-promotion` · rollback procedure drill | 764287d | 2026-07-14 | Ops audit script missing from checkout scripts set at HEAD |
| FFT-AC-008-03 | FFT-MOD-008 | Enterprise Core | CORE-OPERATIONS | Core | Enabled | BLOCKED | `npm run audit:vercel` · prod flag vs Living MOD-008 table | 764287d | 2026-07-14 | Cannot complete release/deploy evidence loop without restored product/ops scripts on this HEAD |
...
**Spine role:** MOD-009 Verification — evidence and result state only. Requirement text stays in MOD-001…008. GUIDE-016 is Retired (archive); do not cite it as AC authority.
