# GUIDE-016 Feed Farm Trade Phase 2A PRD
...
| **Accepted** | 2026-07-09 |
| **Date** | 2026-07-09 |
| **Phase 1 baseline** | commit `1bc1294` · tag `fft-phase-1` · [./phase-1-prd.md](./GUIDE-015-feed-farm-trade-phase-1-prd.md) |
| **Authoritative planning input** | [../archive/phase-2-feedback.md](../archive/GUIDE-020-feed-farm-trade-phase-2-feedback-archive.md) |
| **Candidate-list note** | [../archive/phase-2-scoping.md](../archive/GUIDE-021-feed-farm-trade-phase-2-scoping-archive.md) — sequencing / 7-role framing **superseded** |
| **Normative RBAC ADR** | [../adr/001-rbac.md](../adr/ADR-006-feed-farm-trade-rbac.md) (**Accepted**) |
| **Phase 2A slice plan** | [./phase-2a-slices.md](./GUIDE-017-feed-farm-trade-phase-2a-slices.md) (**closed**) |
| **Ops gate SSOT** | [../ops/gate-register.md](../ops/RB-002-feed-farm-trade-gate-register.md) (**closed**) |

**Vision archive:** [../archive/vision.md](../archive/GUIDE-022-feed-farm-trade-vision-archive.md)

### Implementation gate

ADR-001, this PRD, and [./phase-2a-slices.md](./GUIDE-017-feed-farm-trade-phase-2a-slices.md) are **Accepted / Approved**. **Implementation is closed** (tag `fft-phase-2a` → `8e650ff`).

**Ops rollout:** **closed** 2026-07-10 — [../ops/gate-register.md](../ops/RB-002-feed-farm-trade-gate-register.md). Do not start 2B–2D or reopen 2A product scope.

---

## 1. Phase 1 baseline

Phase 1 delivered a reusable Feed Farm Trade engine under `/fft`:
...
Rollback / bisect reference: tag `fft-phase-1`.

---

## 2. Phase 2 objective

Expand Feed Farm Trade toward multi-role operations, finance/ops workflows, productivity imports, notifications, and eventually ERP sync — **without** breaking Phase 1 compatibility or hardcoding piglet/org-chart specifics into schema or authorization code.
...
**Decision (ADR-002 Accepted 2026-07-10):** Feed Farm Trade deposit records are **operational only**; ERP/Finance remains official settlement SoT until ADR-004. No payment settlement engine inside Feed Farm Trade in 2B.

Keep `fft_order.deposit_status` as a **projection** from deposit records.
...
Suggested: `fft_import_batch`, `fft_import_row`. Controls: templates, max rows, required columns, unknown customer warnings, duplicates, dry-run, error export, audit.

### 6.2 Notifications

Email only first. **ADR-003 Accepted** — dedicated Feed Farm Trade mail lane; not declaration-portal or Neon Auth mail.
...
**ADR-004 Accepted 2026-07-10.** Push-first async sync; ERP remains settlement SoT; adapter interface + noop default. See [../adr/004-erp-sync.md](../adr/ADR-009-feed-farm-trade-erp-sync.md).

Controls: idempotency key, retry, DLQ, manual retry, external mapping, sync status, audit, staging ERP.

Suggested tables: `fft_external_mapping`, `fft_sync_job`, `fft_sync_attempt`, `fft_sync_error`.

AC (draft): idempotent outbound; no duplicate ERP orders; failures visible + manually retryable; local Feed Farm Trade ops not blocked unless configured.
...
Normative detail: [../adr/001-rbac.md](../adr/ADR-006-feed-farm-trade-rbac.md).
...
or the fft-phase-1 rollback reference.
```
...
- [ ] Feed Farm Trade Phase 2 commits stay separate from layout / declaration / playground WIP  
...
| After 2A partial | Leave new RBAC tables unused; keep Phase 1 Admin + allowlist; tag `fft-phase-1` |
...
| Doc | Status |
|-----|--------|
| [../adr/001-rbac.md](../adr/ADR-006-feed-farm-trade-rbac.md) | **Accepted** (2026-07-09) |
| This PRD | **Accepted** (2026-07-09) |
| [./phase-2a-slices.md](./GUIDE-017-feed-farm-trade-phase-2a-slices.md) | **Approved** (2026-07-09) |
| [../adr/002-finance-deposit-pickup-ops.md](../adr/ADR-007-feed-farm-trade-finance-deposit-pickup-ops.md) | **Accepted** (2026-07-10) |
| [../adr/003-imports-notifications.md](../adr/ADR-008-feed-farm-trade-imports-notifications.md) | **Accepted** (2026-07-10) |
| [../adr/004-erp-sync.md](../adr/ADR-009-feed-farm-trade-erp-sync.md) | **Accepted** (2026-07-10) |
| [./phase-2bcd-slices.md](./GUIDE-018-feed-farm-trade-phase-2b-2d-slices.md) | **Proposed** — approve per phase before code |
...
1. **2A + ops closed** — [../ops/gate-register.md](../ops/RB-002-feed-farm-trade-gate-register.md)  
2. **2B–2D ADRs Accepted** — [../adr/002-finance-deposit-pickup-ops.md](../adr/ADR-007-feed-farm-trade-finance-deposit-pickup-ops.md) · [003](../adr/ADR-008-feed-farm-trade-imports-notifications.md) · [004](../adr/ADR-009-feed-farm-trade-erp-sync.md)  
3. **Next for implementation:** approve [./phase-2bcd-slices.md](./GUIDE-018-feed-farm-trade-phase-2b-2d-slices.md) per phase (2B → 2C → 2D); explicit program reopen  
