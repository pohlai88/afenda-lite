# GUIDE-018 Feed Farm Trade Phase 2B-2D Slices
...
| **Proposed** | 2026-07-10 |
| **Date** | 2026-07-10 |
| **Contract** | [./phase-2a-prd.md](./GUIDE-016-feed-farm-trade-phase-2a-prd.md) §§5–7 |
| **ADRs** | [002](../adr/ADR-007-feed-farm-trade-finance-deposit-pickup-ops.md) · [003](../adr/ADR-008-feed-farm-trade-imports-notifications.md) · [004](../adr/ADR-009-feed-farm-trade-erp-sync.md) (**Accepted**) |
...
**ADR:** [002-finance-deposit-pickup-ops.md](../adr/ADR-007-feed-farm-trade-finance-deposit-pickup-ops.md)
...
**2B closure:** Tag `fft-phase-2b` after 2B-4 + smoke — checklist in [ops/gate-register.md](../ops/RB-002-feed-farm-trade-gate-register.md) § Phase 2B closure tag.

---

## Phase 2C — Excel + Notifications

**ADR:** [003-imports-notifications.md](../adr/ADR-008-feed-farm-trade-imports-notifications.md)
...
**2C closure:** Tag `fft-phase-2c` after 2C-4 + notification smoke — checklist in [ops/gate-register.md](../ops/RB-002-feed-farm-trade-gate-register.md) § Phase 2C closure tag.

---

## Phase 2D — ERP sync

**ADR:** [004-erp-sync.md](../adr/ADR-009-feed-farm-trade-erp-sync.md)
...
| **AC** | Integration spec in `docs/modules/feed-farm-trade/integrations/<customer>.md` (or generic stub) |
| **Depends on** | 2C-4 |
...
| **Status** | **Reference pack** — `http-rest` adapter + [integrations/http-rest-vendor-pack.md](../integrations/MOD-005-http-rest-erp-vendor-pack.md); customer fork required for prod |
...
To approve: flip row status to **Approved**, add name + date, update [../RUNTIME.md](../FFT-MOD-008-ops-runtime.md) and [../ops/gate-register.md](../ops/RB-002-feed-farm-trade-gate-register.md).
