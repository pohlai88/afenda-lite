...
**Platform tenancy:** [ADR-002](../../adr/backend/ADR-002-platform-tenancy-rbac.md) · [ARCH-023](../../architecture/turborepo/ARCH-023-multi-tenancy.md) — hard org filters; do not conflate with `FFT_RBAC_ENABLED`.  
...
| Phase 2B–2D impl | [GUIDE-018](spec/GUIDE-018-feed-farm-trade-phase-2b-2d-slices.md) | See RUNTIME history / tags `fft-phase-2b`…`2d` |
...
Full gate history: [RB-002](ops/RB-002-feed-farm-trade-gate-register.md) · rollout [RB-004](ops/RB-004-feed-farm-trade-ops-rollout.md) · readiness [RB-003](ops/RB-003-feed-farm-trade-release-readiness.md).
...
1. Read this file.
2. If the task is **2C+ implementation** — confirm slice group is **Approved** in [GUIDE-018](spec/GUIDE-018-feed-farm-trade-phase-2b-2d-slices.md); else **stop and ask**.
3. Use depth docs only when behavior detail is needed (see [FFT-MOD-010](FFT-MOD-010-module-docs-index.md)).
