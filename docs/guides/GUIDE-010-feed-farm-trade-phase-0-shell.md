# GUIDE-010 Feed Farm Trade Phase 0 Shell
...
| **Phase** | P0 — Shell (MVP prerequisite) per [001R](../adr/frontend/ADR-005-feed-farm-trade-roadmap.md) |
...
None — this is the first phase. It depends only on Identity (session) and Platform (shell/nav config), per the bounded-context map in [001A](../adr/frontend/ADR-004-feed-farm-trade-architecture.md).
...
- [001R-feed-farm-trade-roadmap.md](../adr/frontend/ADR-005-feed-farm-trade-roadmap.md) — P0 section, DoD
- [12-feed-farm-trade-phase1-core-mvp.md](GUIDE-011-feed-farm-trade-phase-1-core-mvp.md) — next phase, depends on this gate
