# GUIDE-007 Organization Admin Phase 1 Tasks
...
**SSOT:** [03-routes.md](../architecture/frontend/ARCH-012-app-router-routes.md) · [02-folder-map.md](../architecture/frontend/ARCH-011-frontend-folder-map.md) · [04-bff-and-data.md](../architecture/frontend/ARCH-013-bff-and-data-flow.md) · [06-admincn-alignment.md](../architecture/frontend/ARCH-015-admincn-alignment.md)
...
- [ ] Diff touches only `app/dashboard/**`, `features/organization-admin/**`, portal-views import remaps, V2 ui gaps (`alert-dialog` / `DialogBody`), and `docs/architecture/frontend` phase-1 docs
