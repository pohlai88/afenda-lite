# GUIDE-014 Organization Admin RBAC Tenancy Tasks
...
**ADR:** [docs/adr/backend/ADR-002-platform-tenancy-rbac.md](../adr/backend/ADR-002-platform-tenancy-rbac.md)
...
|-----------|--------|----------|
| ADR-002 Accepted | **Done** | `docs/adr/backend/ADR-002-platform-tenancy-rbac.md` |
...
| Multi-org ready M1–M4 | **Done** | [ARCH-023](../architecture/turborepo/ARCH-023-multi-tenancy.md) |
...
**Living SSOT:** [ARCH-023](../architecture/turborepo/ARCH-023-multi-tenancy.md).

**Neon efficiency ladder (2026-07-12):** A–E closed — pooler/env, SQL health, Launch recovery (PITR 7d + snapshots), domain hard-root anti-drift (D7), E1 backfill no-op, D8 e2e org resolve fixed. Accepted constraints (not backlog): **D4** (M5 deferred), **D5** (shared-schema). Ops: [multi-org-ops.md](../runbooks/RB-001-multi-org-ops.md).
