# GUIDE-011 Feed Farm Trade Phase 1 Core MVP
...
| **Phase** | P1 — Core cycle (MVP), including gap-register G1–G9, per [001R](../adr/frontend/ADR-005-feed-farm-trade-roadmap.md) |
...
| **Precondition** | [11-feed-farm-trade-phase0-shell.md](GUIDE-010-feed-farm-trade-phase-0-shell.md) satisfied |
...
- Phase 0 shell gate passes (see [11](GUIDE-010-feed-farm-trade-phase-0-shell.md)).
...
| `/fft/admin/events/[eventId]/{deposits,pickup,imports}`, `/fft/admin/erp-sync` | **Out of scope for P1** — P3 placeholders, see [14-feed-farm-trade-phase3-ops-flags.md](GUIDE-013-feed-farm-trade-phase-3-ops-flags.md) |
...
- [ ] `docs/api/REST-001-rest-resources.md` trade rows stay locale-free
...
- [001-feed-farm-trade.md](../adr/frontend/ADR-003-feed-farm-trade-module.md) — decision locks
- [001A-feed-farm-trade-architecture.md](../adr/frontend/ADR-004-feed-farm-trade-architecture.md) — architecture detail
- [001R-feed-farm-trade-roadmap.md](../adr/frontend/ADR-005-feed-farm-trade-roadmap.md) — P1 section, gap register, DoD
- [11-feed-farm-trade-phase0-shell.md](GUIDE-010-feed-farm-trade-phase-0-shell.md) — precondition phase
- [13-feed-farm-trade-phase2-ui-polish.md](GUIDE-012-feed-farm-trade-phase-2-ui-polish.md) · [14-feed-farm-trade-phase3-ops-flags.md](GUIDE-013-feed-farm-trade-phase-3-ops-flags.md) — later, non-blocking phases
