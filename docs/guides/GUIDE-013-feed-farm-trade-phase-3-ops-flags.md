# GUIDE-013 Feed Farm Trade Phase 3 Ops Flags
...
| **Phase** | P3 — Ops flags, not MVP, per [001R](../adr/frontend/ADR-005-feed-farm-trade-roadmap.md) |
| **Build authorization** | **Flag enablement closed** — flags default `false`; enabling in production requires the Feed Farm Trade [gate-register](../modules/feed-farm-trade/ops/RB-002-feed-farm-trade-gate-register.md) checklist. FE placeholder work described here is scoped, not a promotion authorization. |
...
| **Engine ADRs (source of truth for this phase)** | [002 finance/pickup](../modules/feed-farm-trade/adr/ADR-007-feed-farm-trade-finance-deposit-pickup-ops.md) · [003 imports/notifications](../modules/feed-farm-trade/adr/ADR-008-feed-farm-trade-imports-notifications.md) · [004 ERP sync](../modules/feed-farm-trade/adr/ADR-009-feed-farm-trade-erp-sync.md) |
...
- P1 core cycle AC all green (see [12](GUIDE-011-feed-farm-trade-phase-1-core-mvp.md)) — P3 must never be a substitute for a broken P1.
- The relevant engine ADR (002/003/004) is **Accepted** and its slice group is **Approved** in `docs/modules/feed-farm-trade/spec/GUIDE-018-feed-farm-trade-phase-2b-2d-slices.md` before any schema or write-path code — this document does not itself approve a slice.
...
| Rule | No synchronous ERP call in the order/allocation request path; every outbound push carries an idempotency key; sync errors are visible and manually retryable; **2D-1** ships framework + no-op adapter + manual mapping UI + job runner only — a **customer-specific vendor adapter (2D-3) is forbidden without an integration contract**, per both `docs/modules/feed-farm-trade/FFT-MOD-008-ops-runtime.md` and the portal's Feed Farm Trade agent rule |
...
| Ops SSOT alignment | Cross-check flag names and defaults against `docs/modules/feed-farm-trade/FFT-MOD-008-ops-runtime.md` § Env flags — do not let this FE doc drift from that table |
...
- **Doc-drift risk (resolved 2026-07-12):** `docs/modules/feed-farm-trade/FFT-MOD-008-ops-runtime.md` code map now points at `modules/fft/auth/fft-session.ts`, `app/fft/layout.tsx`, and AdminCN — not legacy `trade-session` / `FftShell` paths.
- **Slice-approval risk:** none of the five capabilities may get schema or write-path code until their slice group is Approved in `docs/modules/feed-farm-trade/spec/GUIDE-018-feed-farm-trade-phase-2b-2d-slices.md` — a P3 evaluation finding "code exists" without a recorded approval is itself a finding to report, not a pass.
...
- [001-feed-farm-trade.md](../adr/frontend/ADR-003-feed-farm-trade-module.md) · [001A-feed-farm-trade-architecture.md](../adr/frontend/ADR-004-feed-farm-trade-architecture.md) · [001R-feed-farm-trade-roadmap.md](../adr/frontend/ADR-005-feed-farm-trade-roadmap.md)
- [docs/modules/feed-farm-trade/FFT-MOD-008-ops-runtime.md](../modules/feed-farm-trade/MOD-001-feed-farm-trade-runtime.md) — flags, env defaults, code map (engine SSOT)
- [docs/modules/feed-farm-trade/ops/RB-002-feed-farm-trade-gate-register.md](../modules/feed-farm-trade/ops/RB-002-feed-farm-trade-gate-register.md) — promotion checklist
- [docs/modules/feed-farm-trade/adr/ADR-007-feed-farm-trade-finance-deposit-pickup-ops.md](../modules/feed-farm-trade/adr/ADR-007-feed-farm-trade-finance-deposit-pickup-ops.md)
- [docs/modules/feed-farm-trade/adr/ADR-008-feed-farm-trade-imports-notifications.md](../modules/feed-farm-trade/adr/ADR-008-feed-farm-trade-imports-notifications.md)
- [docs/modules/feed-farm-trade/adr/ADR-009-feed-farm-trade-erp-sync.md](../modules/feed-farm-trade/adr/ADR-009-feed-farm-trade-erp-sync.md)
