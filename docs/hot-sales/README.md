...
**Product module (UI / shell):** **Feed Farm Trade** — not “Hot Sales” in nav/UI. FE SSOT: [doc/frontend/adr/001](../../doc/frontend/adr/001-feed-farm-trade.md) · [001A](../../doc/frontend/adr/001A-feed-farm-trade-architecture.md) · [001R](../../doc/frontend/adr/001R-feed-farm-trade-roadmap.md) · skill [`.cursor/skills/feed-farm-trade`](../../.cursor/skills/feed-farm-trade/SKILL.md).

**Agents — read order:**

1. **[RUNTIME.md](./RUNTIME.md)** — production state, code map, allowed/forbidden (start here for engine/ops)
2. For `/trade` product UI / MVP: FE ADR trio above (001 → 001A → 001R)
