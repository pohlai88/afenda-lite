...
**Related:** [001-modular-monolith-hexagonal.md](./001-modular-monolith-hexagonal.md) · [docs/fft/adr/001-rbac.md](../../fft/adr/001-rbac.md) · Neon Auth Organization plugin (owner/admin/member fixed)
