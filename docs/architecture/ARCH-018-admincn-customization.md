...
**Frontend alignment:** [docs/architecture/frontend/ARCH-015-admincn-alignment.md](frontend/ARCH-015-admincn-alignment.md)  
**Preflight before new screens:** [admincn-frontend-preflight.md](ARCH-019-admincn-frontend-preflight.md)  
...
Product purpose: B2B feed & farm trade sales ([docs/adr/frontend/ADR-003-feed-farm-trade-module.md](../adr/frontend/ADR-003-feed-farm-trade-module.md)).
