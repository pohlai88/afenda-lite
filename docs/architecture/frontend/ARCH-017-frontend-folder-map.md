...
| `components-V2/` | AdminCN shell, ui, portal-views | **Keep product paths** | Prune demos — see [06-admincn-alignment.md](ARCH-015-admincn-alignment.md) |
| `modules/` | Domain, schemas, env, auth, routing (runtime SSOT) | **Keep** | Bounded contexts — see [../backend/ARCH-005-backend-folder-map.md](../backend/ARCH-005-backend-folder-map.md) |
...
| `apps/web/proxy.ts` | Next.js 16 request proxy | **Keep** | Not `middleware.ts` |
...
| `docs/` | Design SSOT · ADRs · API · runbooks · module ops | **Keep** | Unified index: [docs/README.md](../../README.md) |
...
| `features/landing/` | The Machine pre-login landing |
...
|---------|------|---------|
| 1.1.2 | 2026-07-14 | Renumbered from ARCH-029 to ARCH-017; system ARCH-029 remains Interface and API Architecture. |
| 1.1.1 | 2026-07-14 | Added mandatory Control State header field (Closed); lifecycle Status unchanged. |
| 1.1.0 | 2026-07-13 | Renumbered from ARCH-023 to free ID for platform tenancy ARCH-023 |
