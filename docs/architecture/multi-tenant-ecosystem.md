...
| **Decision ADR** | [docs/backend/adr/002-platform-tenancy-rbac.md](../backend/adr/002-platform-tenancy-rbac.md) |
| **Ops runbook** | [docs/runbooks/multi-org-ops.md](../runbooks/multi-org-ops.md) |
| **Phase evidence** | [docs/frontend/14-org-admin-rbac-tenancy-tasks.md](../frontend/14-org-admin-rbac-tenancy-tasks.md) |
...
**Command cheat sheet (consistency):** [docs/runbooks/post-lock-coding-cheatsheet.md](../runbooks/post-lock-coding-cheatsheet.md)
...
| Snapshot schedule | On root/prod branch; test restore before you need it — daily 17:00 UTC + 14d retention + manual baseline; restore drill recorded in [multi-org-ops](../runbooks/multi-org-ops.md) |
...
Ops procedures: [docs/runbooks/multi-org-ops.md](../runbooks/multi-org-ops.md).
...
| **M4** | Ops multi-org | **Shipped** | Org-required backfill + [multi-org-ops runbook](../runbooks/multi-org-ops.md) |
...
| [multi-org-ops runbook](../runbooks/multi-org-ops.md) | Operator procedures |
