...
**Folder map:** [02-folder-map.md](ARCH-005-backend-folder-map.md)  
**API contract:** [../api/](../../api/) · skill `/afenda-elite-api-contract`  
**FE scaffold:** `/afenda-elite-frontend-scaffold` (do not grow `lib/pages` for greenfield UI)
...
4. **Full runner absorb** (entry, org-admin pages, playground) — **complete 2026-07-12** ([residue-inventory](../../../.cursor/skills/afenda-elite-backend-modules/residue-inventory.md)).
