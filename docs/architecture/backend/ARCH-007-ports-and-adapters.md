...
REST shapes: [../api/REST-001-rest-resources.md](../../api/REST-001-rest-resources.md) (Declarations, Assignments, Share links).
...
Documented at resource level in [../api/REST-001-rest-resources.md](../../api/REST-001-rest-resources.md) Feed Farm Trade section. Implementation: `modules/fft/domain/**` + `app/actions/fft.ts`. Web UI uses Actions; HTTP is contract-only until an external consumer needs it.
...
- [../api/API-004-schema-map.md](../../api/API-004-schema-map.md)  
