...
One domain function may serve RSC, Action, and Route Handler adapters. Related BFF tree: [ARCH-013](../frontend/ARCH-013-bff-and-data-flow.md).
...
| [ARCH-013](../frontend/ARCH-013-bff-and-data-flow.md) | BFF and Data Flow | Frontend data tree |
...
Create an ADR under `docs/architecture/decisions/` only when alternatives were materially considered, consequences are long-lived, reversal is costly, or a permanent rationale is required. Do not create ADRs merely to repeat this architecture.
