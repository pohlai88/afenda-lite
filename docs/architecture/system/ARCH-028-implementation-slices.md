...
| `docs/architecture/frontend/ARCH-012`…`ARCH-016` · [ARCH-017](../frontend/ARCH-017-frontend-folder-map.md) | Review → archive or narrow | Folder maps superseded by App Router tree |
