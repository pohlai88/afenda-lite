...
Related: [deprecation register](../../.cursor/skills/agent-skills/skills/deprecation-and-migration/reference.md) · [afenda-elite-backend-modules completeness](../../.cursor/skills/afenda-elite-backend-modules/completeness.md) · [FFT gate-register](../fft/ops/gate-register.md)
...
2. Spec slice under `docs/frontend/` (or phase tasks doc) with AC
...
| **Authority** | [docs/fft/ops/gate-register.md](../fft/ops/gate-register.md) § Prod flag promotion · [docs/frontend/14](../frontend/14-feed-farm-trade-phase3-ops-flags.md) |
