...
All binding content (Decision lock / R1–R7 / D4·D5, Neon shared-schema posture, multi-org M1–M4, efficiency pointers) lives in **ARCH-023**. Ops: [RB-001](../../runbooks/RB-001-multi-org-ops.md). Platform IAM: [ADR-002](../../adr/backend/ADR-002-platform-tenancy-rbac.md). Shared-schema ADR: [ADR-012](../../adr/turborepo/ADR-012-shared-schema-tenancy.md).
