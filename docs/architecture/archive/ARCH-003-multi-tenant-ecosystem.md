...
| Superseded by | [ARCH-023 Multi-Tenancy + Platform RBAC](../system/ARCH-023-multi-tenancy.md) |
...
**Replacement:** [ARCH-023](../system/ARCH-023-multi-tenancy.md) (Living)  
...
All binding content (Decision lock / R1–R7 / D4·D5, Neon shared-schema posture, multi-org M1–M4, efficiency pointers, platform IAM) lives in **[ARCH-023](../system/ARCH-023-multi-tenancy.md)**. Ops: [RB-001](../../runbooks/RB-001-multi-org-ops.md).
