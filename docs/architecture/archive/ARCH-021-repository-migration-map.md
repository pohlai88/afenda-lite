...
| Superseded by | [ARCH-022 System Overview](../turborepo/ARCH-022-system-overview.md) (Target layout) · [ARCH-011](../../architecture/frontend/ARCH-011-frontend-folder-map.md) (frontend folder map) |
...
**Replacement:** Living layout authority is **Target** Turborepo tree in [ARCH-022](../turborepo/ARCH-022-system-overview.md) + frontend map [ARCH-011](../../architecture/frontend/ARCH-011-frontend-folder-map.md). Historical From→To rows are git history / this stub only.  
