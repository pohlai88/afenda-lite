...
| Superseded by | [ARCH-022 System Overview](../system/ARCH-022-system-overview.md) (Target layout) · [ARCH-029](../../architecture/frontend/ARCH-017-frontend-folder-map.md) (frontend folder map) |
...
**Replacement:** Living layout authority is **Target** Turborepo tree in [ARCH-022](../system/ARCH-022-system-overview.md) + frontend map [ARCH-029](../../architecture/frontend/ARCH-017-frontend-folder-map.md). Historical From→To rows are git history / this stub only.  
