# Product Requirements Document: Insurance

> **Document purpose.**
> This PRD defines the `agreement-administration/insurance` feature within Corporate Administration. It translates the approved domain architecture into an executable product and engineering contract without redefining module architecture.
>
...
```yaml
prd_id: CA-AGREEMENT-INSURANCE-001
feature_id: insurance
...
feature_source_path: src/features/agreement-administration/insurance
prd_path: docs/erp/corporate-administration/feature-specs/agreement-administration/insurance/PRD.md
...
required_ports: []
emitted_events:
  - InsurancePolicyRegistered
  - InsuranceQuoteRecorded
  - InsurancePolicyBound
  - InsurancePolicyActivated
  - InsurancePolicyRenewed
  - InsurancePolicyCancelled
  - InsurancePolicyExpired
  - InsurancePolicyClosed
  - InsuranceClaimReferenceLinked
consumed_by: []
estimated_slices: 11
```
...
| Feature identifier | `insurance` |
| Feature group | `agreement-administration` |
| Domain | Corporate Administration |
| One-line definition | The system of record for policies, coverage periods, insured subjects, renewal, and claims references |
...
| Trigger for existence | The organization requires one authoritative, tenant-safe chronology for insurance |
...
> Policies, coverage periods, insured subjects, renewal, and claims references.

This PRD must not materially widen that responsibility.

## 1.2 Feature purpose

Insurance enables authorized users to:
...
Administration users cannot reliably determine the current, authorized, organization-scoped truth for insurance when records, dates, ownership, lifecycle decisions, and evidence are distributed or inconsistently maintained, resulting in missed obligations, ambiguous accountability, weak chronology, and costly assurance reconstruction.
...
This feature solely owns the meaning and lifecycle of: `InsurancePolicy, Coverage, InsuredSubject, ClaimReference`.
...
| --- | --- | --- |
| `insurance` | Policies, coverage periods, insured subjects, renewal, and claims references | Generic “admin item” or another module’s business term |
...
Operation definitions live in `operation-registry.ts`; public outcomes use `Result<Data, Code>`; production persistence uses `insurance.drizzle.ts`; business operations remain in the feature root; events use completed facts in past tense.
...
| --- | --- | --- | --- |
| `InsurancePolicy` | aggregate | `Insurance` | Administrative insurance policy |
| `Coverage` | entity | `Insurance` | Coverage period and scope |
| `InsuredSubject` | entity | `Insurance` | Governed reference to insured entity, premise, or resource |
| `ClaimReference` | entity | `Insurance` | Reference to externally managed claim |
...
| `quoted` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
| `bound` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
...
| `cancelled` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | yes |
...
| --- | --- | --- | --- | --- | --- | --- |
| TR-01 | Current permitted state | `register` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.insurance.manage` | no |
| TR-02 | Current permitted state | `record-quote` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.insurance.manage` | no |
| TR-03 | Current permitted state | `bind` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.insurance.manage` | no |
| TR-04 | Current permitted state | `activate` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.insurance.manage` | yes |
| TR-05 | Current permitted state | `renew` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.insurance.manage` | no |
| TR-06 | Current permitted state | `cancel` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.insurance.manage` | no |
| TR-07 | Current permitted state | `expire` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.insurance.manage` | no |
| TR-08 | Current permitted state | `close` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.insurance.manage` | no |
| TR-09 | Current permitted state | `link-claim` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.insurance.manage` | no |
...
Feature invariants use `CA-INSURANCE-INV-nn` and must include tenant ownership, one semantic owner, chronology preservation, adapter parity, and no secret storage.

# 10. Operation catalog

| Operation ID | Method | Kind | Input | Output | Permission | Approval | Txn | Idempotency | Audit | Emits |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ca.agreement-administration.insurance.register` | `register` | command | `RegisterInsuranceInput` | `InsuranceView` | `ca.insurance.manage` | no | required | request ID | yes | `InsurancePolicyRegistered` |
| `ca.agreement-administration.insurance.record-quote` | `record_quote` | command | `RecordQuoteInsuranceInput` | `InsuranceView` | `ca.insurance.manage` | no | required | request ID | yes | `InsurancePolicyRegistered` |
| `ca.agreement-administration.insurance.bind` | `bind` | command | `BindInsuranceInput` | `InsuranceView` | `ca.insurance.manage` | no | required | request ID | yes | `InsurancePolicyRegistered` |
| `ca.agreement-administration.insurance.activate` | `activate` | command | `ActivateInsuranceInput` | `InsuranceView` | `ca.insurance.manage` | yes | required | request ID | yes | `InsurancePolicyRegistered` |
| `ca.agreement-administration.insurance.renew` | `renew` | command | `RenewInsuranceInput` | `InsuranceView` | `ca.insurance.manage` | no | required | request ID | yes | `InsurancePolicyRegistered` |
| `ca.agreement-administration.insurance.cancel` | `cancel` | command | `CancelInsuranceInput` | `InsuranceView` | `ca.insurance.manage` | no | required | request ID | yes | `InsurancePolicyRegistered` |
| `ca.agreement-administration.insurance.expire` | `expire` | command | `ExpireInsuranceInput` | `InsuranceView` | `ca.insurance.manage` | no | required | request ID | yes | `InsurancePolicyRegistered` |
| `ca.agreement-administration.insurance.close` | `close` | command | `CloseInsuranceInput` | `InsuranceView` | `ca.insurance.manage` | no | required | request ID | yes | `InsurancePolicyRegistered` |
| `ca.agreement-administration.insurance.link-claim` | `link_claim` | command | `LinkClaimInsuranceInput` | `InsuranceView` | `ca.insurance.manage` | no | required | request ID | yes | `InsurancePolicyRegistered` |
| `ca.agreement-administration.insurance.get` | `get` | query | `GetInsuranceInput` | `InsuranceView` | `ca.insurance.read` | — | none | — | no | — |
| `ca.agreement-administration.insurance.list` | `list` | query | `ListInsuranceInput` | `Page<InsuranceView>` | `ca.insurance.read` | — | none | — | no | — |
...
| Permission | Grants |
| --- | --- |
| `ca.insurance.read` | Approved get and list queries |
| `ca.insurance.manage` | Approved mutations |
...
| --- | --- | --- | --- | --- |
| `InsurancePolicyRegistered` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `InsuranceQuoteRecorded` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `InsurancePolicyBound` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `InsurancePolicyActivated` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `InsurancePolicyRenewed` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `InsurancePolicyCancelled` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `InsurancePolicyExpired` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `InsurancePolicyClosed` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `InsuranceClaimReferenceLinked` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
...
```text
/o/{organizationSlug}/corporate-administration/agreement-administration/insurance
```
...
```text
packages/erp/corporate-administration/src/features/agreement-administration/insurance/
...
Primary proposed metric: percentage of active insurance records that are current, assigned, within required dates, and complete with required evidence.
...
| --- | --- | --- |
| FD-01 | Use `insurance` as the canonical feature identifier under `agreement-administration` | proposed |
