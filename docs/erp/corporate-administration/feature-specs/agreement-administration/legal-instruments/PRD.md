# Product Requirements Document: Legal Instruments

> **Document purpose.**
> This PRD defines the `agreement-administration/legal-instruments` feature within Corporate Administration. It translates the approved domain architecture into an executable product and engineering contract without redefining module architecture.
>
...
```yaml
prd_id: CA-AGREEMENT-LEGAL_INSTRUMENTS-001
feature_id: legal-instruments
feature_name: Legal Instruments
...
feature_source_path: src/features/agreement-administration/legal-instruments
prd_path: docs/erp/corporate-administration/feature-specs/agreement-administration/legal-instruments/PRD.md
...
required_ports: []
emitted_events:
  - LegalInstrumentDrafted
  - LegalInstrumentExecuted
  - LegalInstrumentMadeEffective
  - LegalInstrumentAmended
  - LegalInstrumentSuspended
  - LegalInstrumentRevoked
  - LegalInstrumentExpired
  - LegalInstrumentReleased
consumed_by: []
estimated_slices: 11
```
...
| Field | Value |
| --- | --- |
| Feature name | Legal Instruments |
| Feature identifier | `legal-instruments` |
| Feature group | `agreement-administration` |
| Domain | Corporate Administration |
| One-line definition | The system of record for deeds, guarantees, declarations, undertakings, and formal instruments |
...
| Trigger for existence | The organization requires one authoritative, tenant-safe chronology for legal instruments |
...
> Deeds, guarantees, declarations, undertakings, and formal instruments.

This PRD must not materially widen that responsibility.

## 1.2 Feature purpose

Legal Instruments enables authorized users to:
...
Administration users cannot reliably determine the current, authorized, organization-scoped truth for legal instruments when records, dates, ownership, lifecycle decisions, and evidence are distributed or inconsistently maintained, resulting in missed obligations, ambiguous accountability, weak chronology, and costly assurance reconstruction.
...
This feature solely owns the meaning and lifecycle of: `LegalInstrument, InstrumentParty, InstrumentTerm`.
...
| --- | --- | --- |
| `legal-instruments` | Deeds, guarantees, declarations, undertakings, and formal instruments | Generic “admin item” or another module’s business term |
...
Operation definitions live in `operation-registry.ts`; public outcomes use `Result<Data, Code>`; production persistence uses `legal-instruments.drizzle.ts`; business operations remain in the feature root; events use completed facts in past tense.
...
| --- | --- | --- | --- |
| `LegalInstrument` | aggregate | `LegalInstrument` | Deed, guarantee, declaration, undertaking, or formal instrument |
| `InstrumentParty` | entity | `LegalInstrument` | Governed party reference |
| `InstrumentTerm` | entity | `LegalInstrument` | Effective and expiry conditions |
...
| `executed` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
| `effective` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
...
| `revoked` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | yes |
| `released` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | yes |

## 8.2 Proposed transition catalog

| Transition ID | From | Trigger | To | Guard | Permission | Approval |
| --- | --- | --- | --- | --- | --- | --- |
| TR-01 | Current permitted state | `draft` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.legal-instruments.manage` | no |
| TR-02 | Current permitted state | `record-execution` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.legal-instruments.manage` | no |
| TR-03 | Current permitted state | `make-effective` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.legal-instruments.manage` | no |
| TR-04 | Current permitted state | `amend` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.legal-instruments.manage` | no |
| TR-05 | Current permitted state | `suspend` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.legal-instruments.manage` | no |
| TR-06 | Current permitted state | `revoke` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.legal-instruments.manage` | yes |
| TR-07 | Current permitted state | `expire` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.legal-instruments.manage` | no |
| TR-08 | Current permitted state | `release` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.legal-instruments.manage` | no |
...
Feature invariants use `CA-LEGAL_INSTRUMENTS-INV-nn` and must include tenant ownership, one semantic owner, chronology preservation, adapter parity, and no secret storage.

# 10. Operation catalog

| Operation ID | Method | Kind | Input | Output | Permission | Approval | Txn | Idempotency | Audit | Emits |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ca.agreement-administration.legal-instruments.draft` | `draft` | command | `DraftLegalInstrumentInput` | `LegalInstrumentView` | `ca.legal-instruments.manage` | no | required | request ID | yes | `LegalInstrumentDrafted` |
| `ca.agreement-administration.legal-instruments.record-execution` | `record_execution` | command | `RecordExecutionLegalInstrumentInput` | `LegalInstrumentView` | `ca.legal-instruments.manage` | no | required | request ID | yes | `LegalInstrumentDrafted` |
| `ca.agreement-administration.legal-instruments.make-effective` | `make_effective` | command | `MakeEffectiveLegalInstrumentInput` | `LegalInstrumentView` | `ca.legal-instruments.manage` | no | required | request ID | yes | `LegalInstrumentDrafted` |
| `ca.agreement-administration.legal-instruments.amend` | `amend` | command | `AmendLegalInstrumentInput` | `LegalInstrumentView` | `ca.legal-instruments.manage` | no | required | request ID | yes | `LegalInstrumentDrafted` |
| `ca.agreement-administration.legal-instruments.suspend` | `suspend` | command | `SuspendLegalInstrumentInput` | `LegalInstrumentView` | `ca.legal-instruments.manage` | no | required | request ID | yes | `LegalInstrumentDrafted` |
| `ca.agreement-administration.legal-instruments.revoke` | `revoke` | command | `RevokeLegalInstrumentInput` | `LegalInstrumentView` | `ca.legal-instruments.manage` | yes | required | request ID | yes | `LegalInstrumentDrafted` |
| `ca.agreement-administration.legal-instruments.expire` | `expire` | command | `ExpireLegalInstrumentInput` | `LegalInstrumentView` | `ca.legal-instruments.manage` | no | required | request ID | yes | `LegalInstrumentDrafted` |
| `ca.agreement-administration.legal-instruments.release` | `release` | command | `ReleaseLegalInstrumentInput` | `LegalInstrumentView` | `ca.legal-instruments.manage` | no | required | request ID | yes | `LegalInstrumentDrafted` |
| `ca.agreement-administration.legal-instruments.get` | `get` | query | `GetLegalInstrumentInput` | `LegalInstrumentView` | `ca.legal-instruments.read` | — | none | — | no | — |
| `ca.agreement-administration.legal-instruments.list` | `list` | query | `ListLegalInstrumentInput` | `Page<LegalInstrumentView>` | `ca.legal-instruments.read` | — | none | — | no | — |
...
| Permission | Grants |
| --- | --- |
| `ca.legal-instruments.read` | Approved get and list queries |
| `ca.legal-instruments.manage` | Approved mutations |
...
| --- | --- | --- | --- | --- |
| `LegalInstrumentDrafted` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LegalInstrumentExecuted` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LegalInstrumentMadeEffective` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LegalInstrumentAmended` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LegalInstrumentSuspended` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LegalInstrumentRevoked` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LegalInstrumentExpired` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LegalInstrumentReleased` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
...
```text
/o/{organizationSlug}/corporate-administration/agreement-administration/legal-instruments
```
...
```text
packages/erp/corporate-administration/src/features/agreement-administration/legal-instruments/
...
Primary proposed metric: percentage of active legal instruments records that are current, assigned, within required dates, and complete with required evidence.
...
| --- | --- | --- |
| FD-01 | Use `legal-instruments` as the canonical feature identifier under `agreement-administration` | proposed |
