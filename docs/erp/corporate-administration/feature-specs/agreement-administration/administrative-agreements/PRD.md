# Product Requirements Document: Administrative Agreements

> **Document purpose.**
> This PRD defines the `agreement-administration/administrative-agreements` feature within Corporate Administration. It translates the approved domain architecture into an executable product and engineering contract without redefining module architecture.
>
...
```yaml
prd_id: CA-AGREEMENT-ADMINISTRATIVE_AGREEMENTS-001
feature_id: administrative-agreements
feature_name: Administrative Agreements
...
feature_source_path: src/features/agreement-administration/administrative-agreements
prd_path: docs/erp/corporate-administration/feature-specs/agreement-administration/administrative-agreements/PRD.md
...
required_ports: []
emitted_events:
  - AdministrativeAgreementDrafted
  - AdministrativeAgreementSubmittedForReview
  - AdministrativeAgreementActivated
  - AdministrativeAgreementAmended
  - AdministrativeAgreementSuspended
  - AdministrativeAgreementTerminated
  - AdministrativeAgreementExpired
  - AdministrativeAgreementClosed
consumed_by: []
estimated_slices: 11
```
...
| Field | Value |
| --- | --- |
| Feature name | Administrative Agreements |
| Feature identifier | `administrative-agreements` |
| Feature group | `agreement-administration` |
| Domain | Corporate Administration |
| One-line definition | The system of record for administrative vendor, service, support, and facility agreements |
...
| Trigger for existence | The organization requires one authoritative, tenant-safe chronology for administrative agreements |
...
> Administrative vendor, service, support, and facility agreements.

This PRD must not materially widen that responsibility.

## 1.2 Feature purpose

Administrative Agreements enables authorized users to:
...
Administration users cannot reliably determine the current, authorized, organization-scoped truth for administrative agreements when records, dates, ownership, lifecycle decisions, and evidence are distributed or inconsistently maintained, resulting in missed obligations, ambiguous accountability, weak chronology, and costly assurance reconstruction.
...
This feature solely owns the meaning and lifecycle of: `AdministrativeAgreement, AgreementParty, AgreementTerm`.
...
| --- | --- | --- |
| `administrative-agreements` | Administrative vendor, service, support, and facility agreements | Generic “admin item” or another module’s business term |
...
Operation definitions live in `operation-registry.ts`; public outcomes use `Result<Data, Code>`; production persistence uses `administrative-agreements.drizzle.ts`; business operations remain in the feature root; events use completed facts in past tense.
...
| --- | --- | --- | --- |
| `AdministrativeAgreement` | aggregate | `AdministrativeAgreement` | Administrative service, support, vendor, or facility agreement |
| `AgreementParty` | entity | `AdministrativeAgreement` | Governed party reference |
| `AgreementTerm` | entity | `AdministrativeAgreement` | Effective, notice, and renewal terms |
...
| `closed` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | yes |

## 8.2 Proposed transition catalog

| Transition ID | From | Trigger | To | Guard | Permission | Approval |
| --- | --- | --- | --- | --- | --- | --- |
| TR-01 | Current permitted state | `draft` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-agreements.manage` | no |
| TR-02 | Current permitted state | `submit-review` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-agreements.manage` | no |
| TR-03 | Current permitted state | `activate` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-agreements.manage` | yes |
| TR-04 | Current permitted state | `amend` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-agreements.manage` | no |
| TR-05 | Current permitted state | `suspend` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-agreements.manage` | no |
| TR-06 | Current permitted state | `terminate` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-agreements.manage` | yes |
| TR-07 | Current permitted state | `expire` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-agreements.manage` | no |
| TR-08 | Current permitted state | `close` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-agreements.manage` | no |
...
Feature invariants use `CA-ADMINISTRATIVE_AGREEMENTS-INV-nn` and must include tenant ownership, one semantic owner, chronology preservation, adapter parity, and no secret storage.

# 10. Operation catalog

| Operation ID | Method | Kind | Input | Output | Permission | Approval | Txn | Idempotency | Audit | Emits |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ca.agreement-administration.administrative-agreements.draft` | `draft` | command | `DraftAdministrativeAgreementInput` | `AdministrativeAgreementView` | `ca.administrative-agreements.manage` | no | required | request ID | yes | `AdministrativeAgreementDrafted` |
| `ca.agreement-administration.administrative-agreements.submit-review` | `submit_review` | command | `SubmitReviewAdministrativeAgreementInput` | `AdministrativeAgreementView` | `ca.administrative-agreements.manage` | no | required | request ID | yes | `AdministrativeAgreementDrafted` |
| `ca.agreement-administration.administrative-agreements.activate` | `activate` | command | `ActivateAdministrativeAgreementInput` | `AdministrativeAgreementView` | `ca.administrative-agreements.manage` | yes | required | request ID | yes | `AdministrativeAgreementDrafted` |
| `ca.agreement-administration.administrative-agreements.amend` | `amend` | command | `AmendAdministrativeAgreementInput` | `AdministrativeAgreementView` | `ca.administrative-agreements.manage` | no | required | request ID | yes | `AdministrativeAgreementDrafted` |
| `ca.agreement-administration.administrative-agreements.suspend` | `suspend` | command | `SuspendAdministrativeAgreementInput` | `AdministrativeAgreementView` | `ca.administrative-agreements.manage` | no | required | request ID | yes | `AdministrativeAgreementDrafted` |
| `ca.agreement-administration.administrative-agreements.terminate` | `terminate` | command | `TerminateAdministrativeAgreementInput` | `AdministrativeAgreementView` | `ca.administrative-agreements.manage` | yes | required | request ID | yes | `AdministrativeAgreementDrafted` |
| `ca.agreement-administration.administrative-agreements.expire` | `expire` | command | `ExpireAdministrativeAgreementInput` | `AdministrativeAgreementView` | `ca.administrative-agreements.manage` | no | required | request ID | yes | `AdministrativeAgreementDrafted` |
| `ca.agreement-administration.administrative-agreements.close` | `close` | command | `CloseAdministrativeAgreementInput` | `AdministrativeAgreementView` | `ca.administrative-agreements.manage` | no | required | request ID | yes | `AdministrativeAgreementDrafted` |
| `ca.agreement-administration.administrative-agreements.get` | `get` | query | `GetAdministrativeAgreementInput` | `AdministrativeAgreementView` | `ca.administrative-agreements.read` | — | none | — | no | — |
| `ca.agreement-administration.administrative-agreements.list` | `list` | query | `ListAdministrativeAgreementInput` | `Page<AdministrativeAgreementView>` | `ca.administrative-agreements.read` | — | none | — | no | — |
...
| Permission | Grants |
| --- | --- |
| `ca.administrative-agreements.read` | Approved get and list queries |
| `ca.administrative-agreements.manage` | Approved mutations |
...
| --- | --- | --- | --- | --- |
| `AdministrativeAgreementDrafted` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAgreementSubmittedForReview` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAgreementActivated` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAgreementAmended` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAgreementSuspended` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAgreementTerminated` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAgreementExpired` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAgreementClosed` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
...
```text
/o/{organizationSlug}/corporate-administration/agreement-administration/administrative-agreements
```
...
```text
packages/erp/corporate-administration/src/features/agreement-administration/administrative-agreements/
...
Primary proposed metric: percentage of active administrative agreements records that are current, assigned, within required dates, and complete with required evidence.
...
| --- | --- | --- |
| FD-01 | Use `administrative-agreements` as the canonical feature identifier under `agreement-administration` | proposed |
