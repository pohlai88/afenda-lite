# Product Requirements Document: Administrative Assets

> **Document purpose.**
> This PRD defines the `resource-administration/administrative-assets` feature within Corporate Administration. It translates the approved domain architecture into an executable product and engineering contract without redefining module architecture.
>
...
```yaml
prd_id: CA-RESOURCE-ADMINISTRATIVE_ASSETS-001
feature_id: administrative-assets
feature_name: Administrative Assets
...
feature_source_path: src/features/resource-administration/administrative-assets
prd_path: docs/erp/corporate-administration/feature-specs/resource-administration/administrative-assets/PRD.md
...
required_ports: []
emitted_events:
  - AdministrativeAssetRegistered
  - AdministrativeAssetPlacedInService
  - AdministrativeAssetConditionUpdated
  - AdministrativeAssetLocationTransferred
  - AdministrativeAssetReportedLost
  - AdministrativeAssetRecovered
  - AdministrativeAssetRetired
consumed_by: []
estimated_slices: 11
```
...
| Field | Value |
| --- | --- |
| Feature name | Administrative Assets |
| Feature identifier | `administrative-assets` |
| Feature group | `resource-administration` |
| Domain | Corporate Administration |
| One-line definition | The system of record for administrative identity, custody, location, condition, transfer, loss, and retirement from use |
...
| Trigger for existence | The organization requires one authoritative, tenant-safe chronology for administrative assets |
...
> Administrative identity, custody, location, condition, transfer, loss, and retirement from use.

This PRD must not materially widen that responsibility.

## 1.2 Feature purpose

Administrative Assets enables authorized users to:
...
Administration users cannot reliably determine the current, authorized, organization-scoped truth for administrative assets when records, dates, ownership, lifecycle decisions, and evidence are distributed or inconsistently maintained, resulting in missed obligations, ambiguous accountability, weak chronology, and costly assurance reconstruction.
...
This feature solely owns the meaning and lifecycle of: `AdministrativeAsset, AssetCondition, AssetLocation`.
...
| --- | --- | --- |
| `administrative-assets` | Administrative identity, custody, location, condition, transfer, loss, and retirement from use | Generic “admin item” or another module’s business term |
...
Operation definitions live in `operation-registry.ts`; public outcomes use `Result<Data, Code>`; production persistence uses `administrative-assets.drizzle.ts`; business operations remain in the feature root; events use completed facts in past tense.
...
| --- | --- | --- | --- |
| `AdministrativeAsset` | aggregate | `AdministrativeAsset` | Administrative identity and custody record |
| `AssetCondition` | history | `AdministrativeAsset` | Condition chronology |
| `AssetLocation` | history | `AdministrativeAsset` | Administrative location chronology |
...
| --- | --- | --- | --- |
| `registered` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
| `in-service` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
...
| `lost` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
...
| --- | --- | --- | --- | --- | --- | --- |
| TR-01 | Current permitted state | `register` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-assets.manage` | no |
| TR-02 | Current permitted state | `place-in-service` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-assets.manage` | no |
| TR-03 | Current permitted state | `update-condition` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-assets.manage` | no |
| TR-04 | Current permitted state | `transfer-location` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-assets.manage` | no |
| TR-05 | Current permitted state | `report-lost` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-assets.manage` | no |
| TR-06 | Current permitted state | `recover` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-assets.manage` | no |
| TR-07 | Current permitted state | `retire` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.administrative-assets.manage` | no |
...
Feature invariants use `CA-ADMINISTRATIVE_ASSETS-INV-nn` and must include tenant ownership, one semantic owner, chronology preservation, adapter parity, and no secret storage.

# 10. Operation catalog

| Operation ID | Method | Kind | Input | Output | Permission | Approval | Txn | Idempotency | Audit | Emits |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ca.resource-administration.administrative-assets.register` | `register` | command | `RegisterAdministrativeAssetInput` | `AdministrativeAssetView` | `ca.administrative-assets.manage` | no | required | request ID | yes | `AdministrativeAssetRegistered` |
| `ca.resource-administration.administrative-assets.place-in-service` | `place_in_service` | command | `PlaceInServiceAdministrativeAssetInput` | `AdministrativeAssetView` | `ca.administrative-assets.manage` | no | required | request ID | yes | `AdministrativeAssetRegistered` |
| `ca.resource-administration.administrative-assets.update-condition` | `update_condition` | command | `UpdateConditionAdministrativeAssetInput` | `AdministrativeAssetView` | `ca.administrative-assets.manage` | no | required | request ID | yes | `AdministrativeAssetRegistered` |
| `ca.resource-administration.administrative-assets.transfer-location` | `transfer_location` | command | `TransferLocationAdministrativeAssetInput` | `AdministrativeAssetView` | `ca.administrative-assets.manage` | no | required | request ID | yes | `AdministrativeAssetRegistered` |
| `ca.resource-administration.administrative-assets.report-lost` | `report_lost` | command | `ReportLostAdministrativeAssetInput` | `AdministrativeAssetView` | `ca.administrative-assets.manage` | no | required | request ID | yes | `AdministrativeAssetRegistered` |
| `ca.resource-administration.administrative-assets.recover` | `recover` | command | `RecoverAdministrativeAssetInput` | `AdministrativeAssetView` | `ca.administrative-assets.manage` | no | required | request ID | yes | `AdministrativeAssetRegistered` |
| `ca.resource-administration.administrative-assets.retire` | `retire` | command | `RetireAdministrativeAssetInput` | `AdministrativeAssetView` | `ca.administrative-assets.manage` | no | required | request ID | yes | `AdministrativeAssetRegistered` |
| `ca.resource-administration.administrative-assets.get` | `get` | query | `GetAdministrativeAssetInput` | `AdministrativeAssetView` | `ca.administrative-assets.read` | — | none | — | no | — |
| `ca.resource-administration.administrative-assets.list` | `list` | query | `ListAdministrativeAssetInput` | `Page<AdministrativeAssetView>` | `ca.administrative-assets.read` | — | none | — | no | — |
...
| Permission | Grants |
| --- | --- |
| `ca.administrative-assets.read` | Approved get and list queries |
| `ca.administrative-assets.manage` | Approved mutations |
...
| --- | --- | --- | --- | --- |
| `AdministrativeAssetRegistered` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAssetPlacedInService` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAssetConditionUpdated` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAssetLocationTransferred` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAssetReportedLost` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAssetRecovered` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `AdministrativeAssetRetired` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
...
```text
/o/{organizationSlug}/corporate-administration/resource-administration/administrative-assets
```
...
```text
packages/erp/corporate-administration/src/features/resource-administration/administrative-assets/
...
Primary proposed metric: percentage of active administrative assets records that are current, assigned, within required dates, and complete with required evidence.
...
| --- | --- | --- |
| FD-01 | Use `administrative-assets` as the canonical feature identifier under `resource-administration` | proposed |
