# Product Requirements Document: Obligations Calendar

> **Document purpose.**
> This PRD defines the `compliance-administration/obligations-calendar` feature within Corporate Administration. It translates the approved domain architecture into an executable product and engineering contract without redefining module architecture.
>
...
```yaml
prd_id: CA-COMPLIANCE-OBLIGATIONS_CALENDAR-001
feature_id: obligations-calendar
feature_name: Obligations Calendar
...
feature_source_path: src/features/compliance-administration/obligations-calendar
prd_path: docs/erp/corporate-administration/feature-specs/compliance-administration/obligations-calendar/PRD.md
...
| Field | Value |
| --- | --- |
| Feature name | Obligations Calendar |
| Feature identifier | `obligations-calendar` |
| Feature group | `compliance-administration` |
| Domain | Corporate Administration |
| One-line definition | The system of record for shared deadline, notice-period, renewal-window, ownership, and escalation engine |
...
| Trigger for existence | The organization requires one authoritative, tenant-safe chronology for obligations calendar |
...
> Shared deadline, notice-period, renewal-window, ownership, and escalation engine.

This PRD must not materially widen that responsibility.

## 1.2 Feature purpose

Obligations Calendar enables authorized users to:
...
Administration users cannot reliably determine the current, authorized, organization-scoped truth for obligations calendar when records, dates, ownership, lifecycle decisions, and evidence are distributed or inconsistently maintained, resulting in missed obligations, ambiguous accountability, weak chronology, and costly assurance reconstruction.
...
This feature solely owns the meaning and lifecycle of: `Obligation, ObligationOccurrence, Escalation`.
...
| --- | --- | --- |
| `obligations-calendar` | Shared deadline, notice-period, renewal-window, ownership, and escalation engine | Generic “admin item” or another module’s business term |
...
Operation definitions live in `operation-registry.ts`; public outcomes use `Result<Data, Code>`; production persistence uses `obligations-calendar.drizzle.ts`; business operations remain in the feature root; events use completed facts in past tense.
...
| --- | --- | --- | --- |
| `Obligation` | aggregate | `ObligationsCalendar` | Deadline, renewal, notice, filing, or review obligation |
| `ObligationOccurrence` | entity | `ObligationsCalendar` | Dated occurrence and completion state |
| `Escalation` | history | `ObligationsCalendar` | Escalation chronology |
...
| `scheduled` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
| `due` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
...
| `overdue` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
...
| `waived` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |

## 8.2 Proposed transition catalog

| Transition ID | From | Trigger | To | Guard | Permission | Approval |
| --- | --- | --- | --- | --- | --- | --- |
| TR-01 | Current permitted state | `register` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.obligations-calendar.manage` | no |
| TR-02 | Current permitted state | `schedule` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.obligations-calendar.manage` | no |
| TR-03 | Current permitted state | `assign` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.obligations-calendar.manage` | no |
| TR-04 | Current permitted state | `complete` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.obligations-calendar.manage` | no |
| TR-05 | Current permitted state | `waive` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.obligations-calendar.manage` | no |
| TR-06 | Current permitted state | `cancel` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.obligations-calendar.manage` | no |
| TR-07 | Current permitted state | `escalate` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.obligations-calendar.manage` | no |
...
Feature invariants use `CA-OBLIGATIONS_CALENDAR-INV-nn` and must include tenant ownership, one semantic owner, chronology preservation, adapter parity, and no secret storage.

# 10. Operation catalog

| Operation ID | Method | Kind | Input | Output | Permission | Approval | Txn | Idempotency | Audit | Emits |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ca.compliance-administration.obligations-calendar.register` | `register` | command | `RegisterObligationsCalendarInput` | `ObligationsCalendarView` | `ca.obligations-calendar.manage` | no | required | request ID | yes | `ObligationRegistered` |
| `ca.compliance-administration.obligations-calendar.schedule` | `schedule` | command | `ScheduleObligationsCalendarInput` | `ObligationsCalendarView` | `ca.obligations-calendar.manage` | no | required | request ID | yes | `ObligationRegistered` |
| `ca.compliance-administration.obligations-calendar.assign` | `assign` | command | `AssignObligationsCalendarInput` | `ObligationsCalendarView` | `ca.obligations-calendar.manage` | no | required | request ID | yes | `ObligationRegistered` |
| `ca.compliance-administration.obligations-calendar.complete` | `complete` | command | `CompleteObligationsCalendarInput` | `ObligationsCalendarView` | `ca.obligations-calendar.manage` | no | required | request ID | yes | `ObligationRegistered` |
| `ca.compliance-administration.obligations-calendar.waive` | `waive` | command | `WaiveObligationsCalendarInput` | `ObligationsCalendarView` | `ca.obligations-calendar.manage` | no | required | request ID | yes | `ObligationRegistered` |
| `ca.compliance-administration.obligations-calendar.cancel` | `cancel` | command | `CancelObligationsCalendarInput` | `ObligationsCalendarView` | `ca.obligations-calendar.manage` | no | required | request ID | yes | `ObligationRegistered` |
| `ca.compliance-administration.obligations-calendar.escalate` | `escalate` | command | `EscalateObligationsCalendarInput` | `ObligationsCalendarView` | `ca.obligations-calendar.manage` | no | required | request ID | yes | `ObligationRegistered` |
| `ca.compliance-administration.obligations-calendar.get` | `get` | query | `GetObligationsCalendarInput` | `ObligationsCalendarView` | `ca.obligations-calendar.read` | — | none | — | no | — |
| `ca.compliance-administration.obligations-calendar.list` | `list` | query | `ListObligationsCalendarInput` | `Page<ObligationsCalendarView>` | `ca.obligations-calendar.read` | — | none | — | no | — |
...
| Permission | Grants |
| --- | --- |
| `ca.obligations-calendar.read` | Approved get and list queries |
| `ca.obligations-calendar.manage` | Approved mutations |
...
| --- | --- | --- | --- | --- |
| `ObligationRegistered` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `ObligationScheduled` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `ObligationAssigned` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `ObligationCompleted` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `ObligationWaived` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `ObligationCancelled` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `ObligationEscalated` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
...
```text
/o/{organizationSlug}/corporate-administration/compliance-administration/obligations-calendar
```
...
```text
packages/erp/corporate-administration/src/features/compliance-administration/obligations-calendar/
...
Primary proposed metric: percentage of active obligations calendar records that are current, assigned, within required dates, and complete with required evidence.
...
| --- | --- | --- |
| FD-01 | Use `obligations-calendar` as the canonical feature identifier under `compliance-administration` | proposed |
