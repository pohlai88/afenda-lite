# Product Requirements Document: Licences and Permits

> **Document purpose.**
> This PRD defines the `compliance-administration/licences-permits` feature within Corporate Administration. It translates the approved domain architecture into an executable product and engineering contract without redefining module architecture.
>
...
```yaml
prd_id: CA-COMPLIANCE-LICENCES_PERMITS-001
feature_id: licences-permits
feature_name: Licences and Permits
...
feature_source_path: src/features/compliance-administration/licences-permits
prd_path: docs/erp/corporate-administration/feature-specs/compliance-administration/licences-permits/PRD.md
...
required_ports: []
emitted_events:
  - LicencePermitRegistered
  - LicencePermitApplicationRecorded
  - LicencePermitActivated
  - LicencePermitRenewed
  - LicencePermitSuspended
  - LicencePermitRevoked
  - LicencePermitExpired
  - LicencePermitClosed
consumed_by: []
estimated_slices: 11
```
...
| Field | Value |
| --- | --- |
| Feature name | Licences and Permits |
| Feature identifier | `licences-permits` |
| Feature group | `compliance-administration` |
| Domain | Corporate Administration |
| One-line definition | The system of record for licences, permits, registrations, certificates, conditions, and renewals |
...
| Trigger for existence | The organization requires one authoritative, tenant-safe chronology for licences and permits |
...
> Licences, permits, registrations, certificates, conditions, and renewals.

This PRD must not materially widen that responsibility.

## 1.2 Feature purpose

Licences and Permits enables authorized users to:
...
Administration users cannot reliably determine the current, authorized, organization-scoped truth for licences and permits when records, dates, ownership, lifecycle decisions, and evidence are distributed or inconsistently maintained, resulting in missed obligations, ambiguous accountability, weak chronology, and costly assurance reconstruction.
...
This feature solely owns the meaning and lifecycle of: `LicencePermit, Condition, Renewal`.
...
| --- | --- | --- |
| `licences-permits` | Licences, permits, registrations, certificates, conditions, and renewals | Generic “admin item” or another module’s business term |
...
Operation definitions live in `operation-registry.ts`; public outcomes use `Result<Data, Code>`; production persistence uses `licences-permits.drizzle.ts`; business operations remain in the feature root; events use completed facts in past tense.
...
| --- | --- | --- | --- |
| `LicencePermit` | aggregate | `LicencesPermit` | Licence, permit, registration, or certificate |
| `Condition` | entity | `LicencesPermit` | Condition attached to validity |
| `Renewal` | history | `LicencesPermit` | Renewal application and decision chronology |
...
| `applied` | Proposed lifecycle state; exact entry and exit guards require business approval | Defined by approved operations | no |
...
| --- | --- | --- | --- | --- | --- | --- |
| TR-01 | Current permitted state | `register` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.licences-permits.manage` | no |
| TR-02 | Current permitted state | `record-application` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.licences-permits.manage` | no |
| TR-03 | Current permitted state | `activate` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.licences-permits.manage` | yes |
| TR-04 | Current permitted state | `renew` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.licences-permits.manage` | no |
| TR-05 | Current permitted state | `suspend` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.licences-permits.manage` | no |
| TR-06 | Current permitted state | `revoke` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.licences-permits.manage` | yes |
| TR-07 | Current permitted state | `expire` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.licences-permits.manage` | no |
| TR-08 | Current permitted state | `close` | Resulting state defined by approved lifecycle policy | Authorization, tenant lineage, required evidence, and expected version | `ca.licences-permits.manage` | no |
...
Feature invariants use `CA-LICENCES_PERMITS-INV-nn` and must include tenant ownership, one semantic owner, chronology preservation, adapter parity, and no secret storage.

# 10. Operation catalog

| Operation ID | Method | Kind | Input | Output | Permission | Approval | Txn | Idempotency | Audit | Emits |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `ca.compliance-administration.licences-permits.register` | `register` | command | `RegisterLicencesPermitInput` | `LicencesPermitView` | `ca.licences-permits.manage` | no | required | request ID | yes | `LicencePermitRegistered` |
| `ca.compliance-administration.licences-permits.record-application` | `record_application` | command | `RecordApplicationLicencesPermitInput` | `LicencesPermitView` | `ca.licences-permits.manage` | no | required | request ID | yes | `LicencePermitRegistered` |
| `ca.compliance-administration.licences-permits.activate` | `activate` | command | `ActivateLicencesPermitInput` | `LicencesPermitView` | `ca.licences-permits.manage` | yes | required | request ID | yes | `LicencePermitRegistered` |
| `ca.compliance-administration.licences-permits.renew` | `renew` | command | `RenewLicencesPermitInput` | `LicencesPermitView` | `ca.licences-permits.manage` | no | required | request ID | yes | `LicencePermitRegistered` |
| `ca.compliance-administration.licences-permits.suspend` | `suspend` | command | `SuspendLicencesPermitInput` | `LicencesPermitView` | `ca.licences-permits.manage` | no | required | request ID | yes | `LicencePermitRegistered` |
| `ca.compliance-administration.licences-permits.revoke` | `revoke` | command | `RevokeLicencesPermitInput` | `LicencesPermitView` | `ca.licences-permits.manage` | yes | required | request ID | yes | `LicencePermitRegistered` |
| `ca.compliance-administration.licences-permits.expire` | `expire` | command | `ExpireLicencesPermitInput` | `LicencesPermitView` | `ca.licences-permits.manage` | no | required | request ID | yes | `LicencePermitRegistered` |
| `ca.compliance-administration.licences-permits.close` | `close` | command | `CloseLicencesPermitInput` | `LicencesPermitView` | `ca.licences-permits.manage` | no | required | request ID | yes | `LicencePermitRegistered` |
| `ca.compliance-administration.licences-permits.get` | `get` | query | `GetLicencesPermitInput` | `LicencesPermitView` | `ca.licences-permits.read` | — | none | — | no | — |
| `ca.compliance-administration.licences-permits.list` | `list` | query | `ListLicencesPermitInput` | `Page<LicencesPermitView>` | `ca.licences-permits.read` | — | none | — | no | — |
...
| Permission | Grants |
| --- | --- |
| `ca.licences-permits.read` | Approved get and list queries |
| `ca.licences-permits.manage` | Approved mutations |
...
| --- | --- | --- | --- | --- |
| `LicencePermitRegistered` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LicencePermitApplicationRecorded` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LicencePermitActivated` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LicencePermitRenewed` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LicencePermitSuspended` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LicencePermitRevoked` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LicencePermitExpired` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
| `LicencePermitClosed` | Corresponding successful command | organization ID, aggregate ID, effective business facts, schema version | Declared application or module consumers | per aggregate |
...
```text
/o/{organizationSlug}/corporate-administration/compliance-administration/licences-permits
```
...
```text
packages/erp/corporate-administration/src/features/compliance-administration/licences-permits/
...
Primary proposed metric: percentage of active licences and permits records that are current, assigned, within required dates, and complete with required evidence.
...
| --- | --- | --- |
| FD-01 | Use `licences-permits` as the canonical feature identifier under `compliance-administration` | proposed |
