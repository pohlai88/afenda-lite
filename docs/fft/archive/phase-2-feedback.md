# Feed Farm Trade — Phase 2 feedback (authoritative planning direction)
...
**Phase 2A implementation closed** at tag `fft-phase-2a` → `8e650ff`. **Active:** [../ops/gate-register.md](../ops/gate-register.md) (ops rollout only; Gates 1–7 closed). Checklists: [../ops/release-readiness.md](../ops/release-readiness.md) · [../ops/rollout.md](../ops/rollout.md). Do not start 2B–2D.
...
```text
docs/fft/../adr/001-rbac.md
docs/fft/../spec/phase-2a-prd.md
```

## Recommended additional ADRs

```text
docs/fft/adr/002-finance-deposit-pickup-ops.md
docs/fft/adr/003-imports-notifications.md
docs/fft/adr/004-erp-sync.md
docs/fft/spec/phase-2bcd-slices.md
```
...
1. docs/fft/../adr/001-rbac.md
2. docs/fft/../spec/phase-2a-prd.md
