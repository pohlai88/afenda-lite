# S19 — Feed Farm Trade Trade Event Engine (Phase 1)
...
Phase 1 accepted at `1bc1294`. Checklist in [spec/phase-1-prd.md](../spec/phase-1-prd.md). Shipped under `/fft`:
...
**Phase 2A closed** (tag `fft-phase-2a`). **No 2B–2D** without new ADR. See [RUNTIME.md](../RUNTIME.md).
