...
> **Superseded for Feed Farm Trade routes (2026-07-11):** `/fft/[locale]/*` and `features/fft/*` UI listed below were wiped. Live tree is locale-free under `/fft/*` with **AdminCN shell** (not `FftShell`). Treat locale/FftShell rows as historical only — see [docs/frontend/03-routes.md](../../../docs/frontend/03-routes.md).
