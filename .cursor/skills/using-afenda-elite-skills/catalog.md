...
| `afenda-elite-corporate-administration` | local-domain-farm | local | keep | `@afenda/corporate-administration` greenfield package — CA-GREENFIELD-ENTERPRISE-01 · subdomain layout · Model B composed runtime · ca_* sole mutator · slice CA-X.Y · fourteen-boundary acceptance | CA commands · schemas · store · migrations · adapters · legal-company · governance · ca_* · slice handoff | Scratch docs-V2/_scratch/erp/corporate-administration/greenfield · package disk · apps/web CA actions/features | Package exists under `packages/erp/corporate-administration` | `.cursor/skills/afenda-elite-corporate-administration/SKILL.md` · reference.md · verification.md | Greenfield reset; one slice per mission; no pre-greenfield CA legacy; Scratch authority progressive only |
