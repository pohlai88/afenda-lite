...
| Route Handler body/query | **Untrusted** | Zod → same error shape as [doc/api/03-error-contract.md](../../../doc/api/03-error-contract.md) |
...
Web UI uses RSC + Actions. REST catalog in doc/api is for external consumers later — **one version**, extend additively.
