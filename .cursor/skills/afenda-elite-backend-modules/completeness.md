...
Plan authority: this skill + `docs/backend/` + [closed-scope-register](../../../docs/architecture/closed-scope-register.md).
...
| Multi-org ready (M1–M4) | Switcher + scoped templates + isolation + ops | [multi-tenant-ecosystem.md](../../../docs/architecture/multi-tenant-ecosystem.md) | **Done** |
