...
**Progress hint (checkout):** ARCH-028 S1–S8 + Checkpoints A–**G** **closed**. Current program: [GUIDE-018](../../../docs/guides/GUIDE-018-fullstack-e2e-integration-program.md) Phase **I2** — **I1** done; next **I2.1**. Evidence on disk wins over this hint.
