...
|----|-------------------|------|--------------------|------------------|------------------------|-------|------------|---------|
| **N1** | Typed Neon env contract | Ops | router → slices → neon → neon-vendor | ARCH-027 · AGENTS | `@afenda/env` typecheck/tests · `pnpm validate:neon-env` · web build if env structural | UNEVALUATED | — | — |
