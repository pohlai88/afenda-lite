...
**Program pointer:** last APPROVED = **N6** (independent audit 2026-07-17). Next = **N7** — authorize only after human auth in a fresh mission chat; do **not** sneak-start here. (N4 remains UNEVALUATED on the serial map; N5–N6 closed under explicit human mission auth.)
