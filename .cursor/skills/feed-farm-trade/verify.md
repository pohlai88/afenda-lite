...
**Bar:** Enterprise MVP = P0 + P1 (G1–G6) **with recorded evidence**. Wiring alone ≠ done ([001R](../../../docs/frontend/adr/001R-feed-farm-trade-roadmap.md)).
...
Fill phase-doc **Result** columns when evaluating: [11](../../../docs/frontend/11-feed-farm-trade-phase0-shell.md) · [12](../../../docs/frontend/12-feed-farm-trade-phase1-core-mvp.md).
