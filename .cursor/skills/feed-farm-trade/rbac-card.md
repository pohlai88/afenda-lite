...
**Module entry (control plane):** platform permission `fft.access` via `hasFftModuleAccess` / `requireFftAccess` — **not** the sales allowlist and **not** FFT domain assignment alone. Tenancy: [ARCH-023](../../../docs/architecture/turborepo/ARCH-023-multi-tenancy.md).
