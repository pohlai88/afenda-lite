...
| Forward product code | Continue ARCH-028 slices under `apps/web/**` and `packages/*` only — greenfield new code; never restore banned roots; next open **S7.4** (feature shells) |
