/**
 * Gates package scripts whose Collapse-era implementations were removed.
 * New file for this checkout — do not replace with git-recovered script bodies.
 * Authority: docs/architecture/ARCH-028-implementation-slices.md Anti-contamination lock
 */
