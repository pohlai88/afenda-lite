...
import {
  filterTradeAuditRows,
  listAuditActors,
  toTradeAuditListItems,
  type TradeAuditListItem,
} from "@/features/trade/trade-audit-filter-model";

const rows: TradeAuditListItem[] = [
  {
    id: "1",
...
describe("trade-audit-filter-model (P2-AC-03)", () => {
  ...
  it("maps store rows to list items", () => {
    const mapped = toTradeAuditListItems([
      {
        id: "a1",
