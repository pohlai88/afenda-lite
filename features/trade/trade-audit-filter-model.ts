...
export type TradeAuditListItem = {
  id: string;
...
export type TradeAuditListFilters = {
  actorId: string; // "" = all
...
export function listAuditActors(rows: TradeAuditListItem[]): string[] {
...
export function filterTradeAuditRows(
  rows: TradeAuditListItem[],
  filters: TradeAuditListFilters,
): TradeAuditListItem[] {
...
export function toTradeAuditListItems(
  rows: Array<{
    id?: string | number;
