	...
	return (
		<WorkspacePage width="wide">
			<WorkspacePageHeader
				...
				scope={`Employee self-service · ${preferences.timeZone}`}
	...
	return (
		<WorkspacePage width="wide">
			<WorkspacePageHeader
				...
				scope="Operator · Human resources"
