...
export async function FulfillmentShell({ surface }: FulfillmentShellProps) {
	...
	return (
		<WorkspacePage>
			<WorkspacePageHeader
				description="Create outbound deliveries, add lines, pick, pack, post, record proof of delivery, close delivered deliveries, and cancel eligible drafts."
				scope={`${surface === "admin" ? "Operator" : "Client"} · Fulfillment`}
				title="Deliveries"
			/>
			<WorkspacePageContent>
