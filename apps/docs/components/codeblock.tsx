	...
	return (
		...
		>
			...
			<section
				...
				{...viewportProps}
				className={cn(
					"fd-scroll-container max-h-[600px] overflow-auto py-3.5 text-[0.8125rem] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fd-ring focus-visible:ring-inset",
