	...
	return (
		<Card className="shadow-none">
			<CardHeader className="gap-1 pb-3">
				<CardTitle className="font-medium text-foreground-secondary text-sm">
					{title}
				</CardTitle>
			</CardHeader>
							...
							>
								...
								<CardContent className="grid gap-6">
									...
									<div className="rounded-md bg-surface-sunken p-4">
										...
										<p className="mt-1 text-foreground-secondary text-sm leading-5">
						...
						>
							...
							>
								...
								<CardContent className="grid gap-5">
									...
									<div className="grid gap-2">
										<p className="font-medium text-sm">Failure consequence</p>
										<p className="mt-1 text-foreground-secondary text-sm leading-5">
						...
						>
							<CardContent className="grid gap-5 p-5 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
								...
								<div className="flex flex-wrap items-center gap-4">
									<p className="font-medium font-mono text-sm">MYR 12,150.00</p>
									<Button size="sm" type="button" variant="outline">
										View ledger entry
									</Button>
								</div>
				...
				<Card className="shadow-none">
					...
					<CardContent>
						<dl className="grid gap-4 sm:grid-cols-3">
							...
							<DefinitionItem
								label="Lifecycle"
								value={<StatusBadge label="Active" size="sm" status="active" />}
							/>
						</dl>
					</CardContent>
				</Card>
			...
			<StorySection title="Decision Card">
				<Card className="shadow-none">
					...
					<CardContent className="grid gap-4">
						...
						<div className="rounded-md bg-surface-sunken p-4">
							<p className="font-medium text-sm">Approval consequence</p>
