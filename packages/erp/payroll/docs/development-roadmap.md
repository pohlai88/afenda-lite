...
| D4 final settlement | **CLOSED** | Termination pay from a pinned compensation snapshot, fail-closed statutory calculator seam, C6 human clearance, C9 finalize SoD, read-own/read-all statement query, audit+outbox settlement lifecycle events; migrate `0053_payroll_final_settlement` remains ops-gated |
