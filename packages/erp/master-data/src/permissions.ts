...
export const MASTER_DATA_PERMISSION_TAX_REGISTRATION_NUMBER_READ =
	"master_data.tax_registration_number_read" as const;
export const MASTER_DATA_PERMISSION_PERSONAL_CONTACT_READ =
	"master_data.personal_contact_read" as const;
...
export const MASTER_DATA_FIELD_PERMISSION_CODES = [
	MASTER_DATA_PERMISSION_TAX_REGISTRATION_NUMBER_READ,
	MASTER_DATA_PERMISSION_PERSONAL_CONTACT_READ,
