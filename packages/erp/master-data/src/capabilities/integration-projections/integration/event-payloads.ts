...
export type MasterDataEventPayloadMap = Readonly<{
	...
	"master_data.party.suspended": MasterAggregateChangedPayload;
	...
	"master_data.organization_dimension.created": MasterAggregateChangedPayload;
	"master_data.organization_dimension.updated": MasterAggregateChangedPayload;
	...
	"master_data.warehouse.created": MasterAggregateChangedPayload;
	...
	"master_data.import_batch.approved": MasterAggregateChangedPayload;
