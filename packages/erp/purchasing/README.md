...
| Metrics | Metric names and labels are not domain exports. Application composition may report approved facts only through the canonical `@afenda/metrics` capability. Platform scrape: `GET /api/metrics`. |
