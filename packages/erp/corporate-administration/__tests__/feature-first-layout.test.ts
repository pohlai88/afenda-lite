...
/**
 * Feature-first root allowlist (ERP-SCAFFOLDING §3; facade/ is a permission,
 * not a requirement — corporate-administration has no facade layer today).
...
describe("corporate-administration feature-first layout", () => {
