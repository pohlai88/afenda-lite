...
import { toImmutableCanonicalJson } from "../canonical-json";
import { toCanonicalInstant } from "../dates";
import { createCorporateAdministrationDomainEventEnvelope } from "../emissions/domain-events";
import type { CorporateAdministrationMutationTable } from "../emissions/mutation-tables";
import { createCorporateAdministrationCommandFingerprint } from "../execution/command-identity";
import type { CorporateAdministrationCommandOptions } from "../execution/command-options";
import {
...
import type { CorporateAdministrationCommandDefinition } from "../operations/types";
