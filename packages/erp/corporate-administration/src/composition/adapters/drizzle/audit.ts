...
import { corporateAdministrationAuditFactInputSchema } from "../../../kernel/execution/ports";
import type { CorporateAdministrationAuditWriter } from "../../../kernel/infrastructure/drizzle-dependencies";
