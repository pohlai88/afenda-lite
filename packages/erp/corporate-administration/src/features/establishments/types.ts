...
import type {
	...
	legalEstablishmentListPageSchema,
...
export type LegalEstablishmentListPage = z.infer<
	typeof legalEstablishmentListPageSchema
>;
...
export type PremiseListPage = z.infer<typeof premiseListPageSchema>;
