...
export const legalEstablishmentListPageSchema = z
	.object({
		items: z.array(legalEstablishmentSchema).readonly(),
...
export const premiseListPageSchema = z
	.object({
		items: z.array(premiseSchema).readonly(),
		nextCursor: opaqueCursorSchema.nullable(),
	})
	.readonly();
