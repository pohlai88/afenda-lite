...
export type RequiredStatutoryOfficesQuery = Readonly<{
	organizationId: OrganizationId;
	legalCompanyId: LegalCompanyId;
	asOf: CanonicalDate;
...
export type OfficersAsOfQuery = Readonly<{
	organizationId: OrganizationId;
	legalCompanyId: LegalCompanyId;
	asOf: CanonicalDate;
...
export interface OfficerStore {
	...
	listOfficersAsOf: (
		input: OfficersAsOfQuery,
	) => Promise<Result<OfficerAppointmentListPage>>;
	listRequiredStatutoryOffices: (
		input: RequiredStatutoryOfficesQuery,
	) => Promise<Result<StatutoryOfficeListPage>>;
