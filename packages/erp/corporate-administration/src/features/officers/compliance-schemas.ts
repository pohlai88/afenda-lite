...
export const officerDeclarationListPageSchema = z
	.object({
		items: z.array(officerDeclarationSchema).readonly(),
...
export const officerDisqualificationListPageSchema = z
	.object({
		items: z.array(officerDisqualificationSchema).readonly(),
		nextCursor: opaqueCursorSchema.nullable(),
	})
	.readonly();
...
export const conflictDisclosureListPageSchema = z
	.object({
		items: z.array(conflictDisclosureSchema).readonly(),
		nextCursor: opaqueCursorSchema.nullable(),
	})
	.readonly();
