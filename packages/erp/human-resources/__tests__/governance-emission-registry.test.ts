...
const EMPLOYEE_RELATIONS_MATRIX: Record<string, EmissionExpectation> = {
	...
	[HUMAN_RESOURCES_COMMAND_EMPLOYEE_CASE_RECORD_EVENT]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_EMPLOYEE_CASE_ADD_EVIDENCE_REFERENCE]: {
		emission: "audit_only",
	},
	[HUMAN_RESOURCES_COMMAND_EMPLOYEE_CASE_REDACT_EVIDENCE_REFERENCE]: {
	...
	[HUMAN_RESOURCES_COMMAND_EMPLOYEE_CASE_RECOMMEND_ACTION]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_EMPLOYEE_CASE_APPROVE_ACTION]: {
		emission: "domain_event",
...
const COMPLIANCE_MATRIX: Record<string, EmissionExpectation> = {
	[HUMAN_RESOURCES_COMMAND_DOCUMENT_REQUIREMENT_CREATE]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_DOCUMENT_REQUIREMENT_UPDATE]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_DOCUMENT_REQUIREMENT_PUBLISH]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_DOCUMENT_REQUIREMENT_RETIRE]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_EMPLOYEE_DOCUMENT_REGISTER]: {
		emission: "domain_event",
		eventTypes: [
			HUMAN_RESOURCES_EMPLOYEE_DOCUMENT_REGISTERED_EVENT,
	...
	[HUMAN_RESOURCES_COMMAND_POLICY_ACKNOWLEDGEMENT_REVOKE]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_POLICY_ACKNOWLEDGEMENT_SUPERSEDE]: {
		emission: "audit_only",
	},
};
...
const TALENT_MATRIX: Record<string, EmissionExpectation> = {
	...
	[HUMAN_RESOURCES_COMMAND_TALENT_POOL_MEMBER_NOMINATE]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_TALENT_POOL_MEMBER_APPROVE]: {
		emission: "domain_event",
	...
	[HUMAN_RESOURCES_COMMAND_CAREER_PLAN_ACTION_COMPLETE]: { emission: "audit_only" },
	...
	[HUMAN_RESOURCES_COMMAND_SUCCESSION_CANDIDATE_NOMINATE]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_SUCCESSION_CANDIDATE_ASSESS_READINESS]: {
		emission: "domain_event",
...
const WORKFORCE_PLANNING_MATRIX: Record<string, EmissionExpectation> = {
	...
	[HUMAN_RESOURCES_COMMAND_HEADCOUNT_PLAN_LINE_UPDATE]: { emission: "audit_only" },
	[HUMAN_RESOURCES_COMMAND_HEADCOUNT_PLAN_LINE_REMOVE]: { emission: "audit_only" },
	...
	[HUMAN_RESOURCES_COMMAND_HEADCOUNT_PLAN_SUPERSEDE]: { emission: "audit_only" },
...
describe("compliance emission registry", () => {
	...
	it("matches the locked 20-row mode/eventType matrix", () => {
		assertLockedMatrix(HUMAN_RESOURCES_COMPLIANCE_COMMAND_IDS, COMPLIANCE_MATRIX);
	});
});
...
describe("talent emission registry", () => {
	...
	it("matches the locked 32-row mode/eventType matrix", () => {
