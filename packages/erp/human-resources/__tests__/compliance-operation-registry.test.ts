...
} from "../src/features/compliance/operation-registry";
...
const handlerSources = [
	...
	readFileSync(
		path.resolve(import.meta.dirname, `../src/features/compliance/${fileName}`),
		"utf8",
	),
);
const runnerSource = readFileSync(
	path.resolve(
		import.meta.dirname,
		"../src/features/compliance/run-operation.ts",
	),
	"utf8",
);
const policySource = readFileSync(
	path.resolve(
		import.meta.dirname,
		"../src/features/compliance/authorization/compliance.ts",
	),
	"utf8",
);
const storeSource = readFileSync(
	path.resolve(import.meta.dirname, "../src/features/compliance/store.ts"),
	"utf8",
);
