...
import type { HumanResourcesRetentionClassification } from "../../privacy/contract";
...
export interface EmployeeOrganizationEntry {
	...
	enteredOn: string;
	orgContext:
		| import("../../../kernel/validation/org-context").EmployeeOrgContextAsOf
		| null;
}
...
export interface EmployeeProfile {
	...
	employmentId:
		| import("../../../kernel/identity/brands").HumanResourcesEmploymentId
		| null;
	employmentStatus:
		| import("../employment/employment-status").EmploymentStatus
		| null;
