...
import { projectPerformanceReviewDetailForReader } from "../performance-field-projection";
import {
...
function buildPerformanceMemoryMethods(
	...
	return {
		...
		async listGoalProgress(input: {
			...
			Result<
				import("../../../kernel/contracts").PerformanceGoalProgressListPage
			>
		> {
