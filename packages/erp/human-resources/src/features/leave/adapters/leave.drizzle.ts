...
import { getRegistryDomainEventType } from "../../../kernel/emissions/mutation-emission-registry";
import { planLeaveMutationOutboxEventType } from "../../../kernel/emissions/sql-side-effects";
...
} from "./leave-sql-builders.drizzle";
import {
...
} from "./leave-transactions.drizzle";
...
type LeaveHost = {
	...
	}) => Promise<Result<import("../../../kernel/contracts").Employment | null>>;
