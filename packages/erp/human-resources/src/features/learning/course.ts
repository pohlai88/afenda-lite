...
import type { CourseListPage, LearningCourse } from "../../kernel/contracts";
...
import { fingerprintCourseCreate } from "../../kernel/identity/fingerprint";
import {
	...
	return runLearningCapabilityCommand(input, options, {
		...
		execute: async (data, { store, ports }) => {
			...
			if (existingByKey.data !== null) {
				...
				return errorResult.ok(existingByKey.data.course);
			}
