...
export type HumanResourcesPrivacyCommandId =
	...
	| typeof HUMAN_RESOURCES_COMMAND_PRIVACY_RESTRICTION_LIFT
	| typeof HUMAN_RESOURCES_COMMAND_PRIVACY_RESTRICTION_PLACE
...
export const HUMAN_RESOURCES_PRIVACY_EMISSIONS = {
	...
	[HUMAN_RESOURCES_COMMAND_PRIVACY_RESTRICTION_PLACE]: defineAuditOnlyEmission(
		HUMAN_RESOURCES_COMMAND_PRIVACY_RESTRICTION_PLACE,
		{
			domain: "privacy",
	...
	[HUMAN_RESOURCES_COMMAND_PRIVACY_RESTRICTION_LIFT]: defineAuditOnlyEmission(
		HUMAN_RESOURCES_COMMAND_PRIVACY_RESTRICTION_LIFT,
		{
			domain: "privacy",
			aggregateType: "privacy_restriction",
