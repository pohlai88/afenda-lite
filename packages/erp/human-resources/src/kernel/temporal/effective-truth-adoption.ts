import { HUMAN_RESOURCES_MUTATION_TABLES } from "../emissions/mutation-tables";
 ...
 * Slice 4.1 package-wide completeness lives in `effective-truth-classification.ts`.
 */
export const HUMAN_RESOURCES_EFFECTIVE_TRUTH_ADOPTION = [
	{
		aggregate: "person-identity",
		table: "hr_person",
		...
		evidence: FOUNDATION_HISTORY_EVIDENCE,
	},
	{
		aggregate: "person-identity-lineage",
		table: "hr_person_identity_version",
		domain: "workforce-foundation",
		decision: "effective-lineage",
		rangeFields: ["effectiveFrom", "effectiveTo"],
		predecessorField: "supersedesIdentityVersionId",
		successorField: null,
		concurrency: "version",
		provenance: "audit-outbox",
		resolution: "as-of",
	...
	{
		aggregate: "worker-classification-lineage",
		table: "hr_worker_classification_version",
		domain: "workforce-foundation",
		decision: "effective-lineage",
		rangeFields: ["effectiveFrom", "effectiveTo"],
		predecessorField: "supersedesClassificationVersionId",
		successorField: null,
		concurrency: "version",
		provenance: "audit-outbox",
		resolution: "as-of",
	...
	{
		aggregate: "department-structure-lineage",
		table: "hr_department_structure_version",
		domain: "organization",
		decision: "effective-lineage",
		rangeFields: ["effectiveFrom", "effectiveTo"],
		predecessorField: "supersedesStructureVersionId",
		successorField: null,
		concurrency: "version",
		provenance: "audit-outbox",
		resolution: "as-of",
	...
	{
		aggregate: "job-definition-lineage",
		table: "hr_job_definition_version",
		domain: "organization",
		decision: "effective-lineage",
		rangeFields: ["effectiveFrom", "effectiveTo"],
		predecessorField: "supersedesDefinitionVersionId",
		successorField: null,
		concurrency: "version",
		provenance: "audit-outbox",
		resolution: "as-of",
	...
	{
		aggregate: "position-definition-lineage",
