...
export type HumanResourcesStatutoryProfileCommandId =
	(typeof HUMAN_RESOURCES_STATUTORY_PROFILE_COMMAND_IDS)[number];
export type HumanResourcesStatutoryProfileQueryId =
	(typeof HUMAN_RESOURCES_STATUTORY_PROFILE_QUERY_IDS)[number];
