...
import {
	attachDrizzleCompliance,
	type DrizzleComplianceMethods,
} from "./compliance";
import {
	attachDrizzleEmployeeRelations,
	type DrizzleEmployeeRelationsMethods,
} from "./employee-relations";
import { attachDrizzleLearning, type DrizzleLearningMethods } from "./learning";
import {
	attachDrizzlePerformance,
	type DrizzlePerformanceMethods,
} from "./performance";
import { attachDrizzleLeave, type DrizzleLeaveMethods } from "./leave";
import {
...
type DrizzleWorkforceStore = Omit<
	...
	| keyof DrizzleCompensationMethods
	| keyof DrizzleComplianceMethods
	| keyof DrizzleLearningMethods
...
export class DrizzleHumanResourcesStore {
	constructor() {
		...
		attachDrizzleCompliance(
			this as unknown as Parameters<typeof attachDrizzleCompliance>[0],
		);
		attachDrizzleLearning(
			this as unknown as Parameters<typeof attachDrizzleLearning>[0],
		);
		attachDrizzleLeave(
			this as unknown as Parameters<typeof attachDrizzleLeave>[0],
		);
		attachDrizzlePerformance(
			this as unknown as Parameters<typeof attachDrizzlePerformance>[0],
		);
		attachDrizzleEmployeeRelations(
