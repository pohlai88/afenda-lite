...
async function assertReportingLineAssignable(host: DrizzleOrganizationHost & DrizzleOrganizationMethods, input: {
...
export function attachDrizzleOrganization(target: DrizzleOrganizationHost): void {
