...
import { INVENTORY_PERMISSION_ADJUSTMENT_POST } from "../kernel/execution/permissions";
import {
...
import { normalizeMovementCode } from "../kernel/validation/code";
import { parseInventoryInput } from "../kernel/validation/parse-input";
import { type InventoryCommandOptions, resolveCommandDeps } from "./contracts";
