...
const erpLight = {
	...
	"success-subtle-foreground": "oklch(0.393 0.095 152.535)",
	"success-border": "oklch(0.792 0.142 152.535)",
	warning: "oklch(0.76 0.12 80)",
	"warning-foreground": "oklch(0.205 0 0)",
	"warning-subtle": "oklch(0.973 0.071 103.193)",
	"warning-subtle-foreground": "oklch(0.421 0.095 57.708)",
	"warning-border": "oklch(0.828 0.189 84.429)",
	info: "oklch(0.546 0.245 262.881)",
	"info-foreground": "oklch(0.985 0 0)",
	"info-subtle": "oklch(0.951 0.026 236.824)",
	"info-subtle-foreground": "oklch(0.379 0.146 265.522)",
	"info-border": "oklch(0.809 0.105 251.813)",
	"destructive-foreground": "oklch(0.985 0 0)",
	"destructive-subtle": "oklch(0.971 0.013 17.38)",
	"destructive-subtle-foreground": "oklch(0.444 0.177 26.899)",
...
const erpDark = {
	...
	"success-subtle-foreground": "oklch(0.88 0.06 155)",
	"success-border": "oklch(0.68 0.08 155)",
	warning: "oklch(0.76 0.12 80)",
	"warning-foreground": "oklch(0.205 0 0)",
	"warning-subtle": "oklch(0.279 0.077 45.635)",
	"warning-subtle-foreground": "oklch(0.88 0.06 80)",
	"warning-border": "oklch(0.68 0.08 80)",
	info: "oklch(0.75 0.12 245)",
	"info-foreground": "oklch(0.145 0 0)",
	"info-subtle": "oklch(0.282 0.091 267.935)",
	"info-subtle-foreground": "oklch(0.88 0.06 245)",
	"info-border": "oklch(0.68 0.08 245)",
	"destructive-foreground": "oklch(0.985 0 0)",
	"destructive-subtle": "oklch(0.258 0.092 26.042)",
	"destructive-subtle-foreground": "oklch(0.88 0.06 25)",
