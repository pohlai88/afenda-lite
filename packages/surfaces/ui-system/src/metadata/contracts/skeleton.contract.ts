...
export const skeletonContract = defineManifestContract({
	...
	purpose:
		"Provides non-semantic loading placeholders that preserve expected ERP content layout while authoritative data loads.",
	ownership: {
		componentOwns: [
	...
	semanticBoundaries: [
		...
		"Skeleton does not replace Spinner for indeterminate busy controls or Empty for completed empty collections.",
	],
	rules: [
		...
		"Mark the owning region busy when operators need a loading announcement.",
		"Hide decorative skeleton bars from assistive technologies.",
	],
	accessibility: [
	...
	prohibitedUsage: [
		...
		"Do not announce every individual placeholder.",
		"Do not fabricate realistic field values inside skeletons.",
		"Do not use Skeleton to imply authorization or success.",
	],
});
