...
import ResetPasswordV3Form from '#views/pages/auth/reset-password/reset-password-v3/reset-password-v3-form'
        ...
        <div className='flex w-full flex-col gap-6 p-6 sm:max-w-lg'>
          ...
          <div className='space-y-4'>
            ...
            <Button
              ...
              render={<Link href='/pages/auth/login-v3' />}
              nativeButton={false}
            >
        ...
        <Card className='relative h-full justify-between overflow-hidden border-none py-8'>
          ...
          <CardHeader className='relative z-10 gap-6 px-8'>
            ...
            <p className='text-xl text-white'>
              Please create a new password below. Make sure it&apos;s strong and secure, combining letters, numbers, and
              special characters.
            </p>
          </CardHeader>
