...
import { DollarSignIcon, ShoppingCartIcon, ChevronUpIcon, EllipsisVerticalIcon } from 'lucide-react'
    ...
    <Card className={cn('gap-4', className)}>
      ...
      <CardContent className='flex flex-col justify-between gap-4'>
        <ChartContainer config={totalEarningChartConfig} className='min-h-37.5 w-full'>
          <BarChart data={totalEarningChartData} stackOffset='sign' margin={{ right: 0, left: 0 }} barSize={12}>
