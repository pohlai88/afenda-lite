...
export const PLATFORM_PERMISSION_V1 = [
	...
	{
		code: "corporate-administration.company.create",
		module: "corporate-administration",
		description: "Create draft legal companies",
		sensitive: true,
	},
	{
		code: "corporate-administration.company.update",
		module: "corporate-administration",
		description: "Update draft legal company facts",
		sensitive: true,
	},
	{
		code: "corporate-administration.company.activate",
		module: "corporate-administration",
		description: "Activate legal companies",
		sensitive: true,
	},
	{
		code: "corporate-administration.company.suspend",
		module: "corporate-administration",
		description: "Suspend active legal companies",
		sensitive: true,
	},
	{
		code: "corporate-administration.company.dissolve",
		module: "corporate-administration",
		description: "Dissolve legal companies",
		sensitive: true,
	},
	{
		code: "corporate-administration.company.archive",
		module: "corporate-administration",
		description: "Archive legal companies",
		sensitive: true,
	},
	{
		code: "corporate-administration.company.read",
		module: "corporate-administration",
		description: "Read legal company detail",
		sensitive: false,
	},
	{
		code: "corporate-administration.company.list",
		module: "corporate-administration",
		description: "List legal companies",
		sensitive: false,
	},
	{
		code: "corporate-administration.company-name.manage",
		module: "corporate-administration",
		description: "Manage legal company names",
		sensitive: true,
	},
	{
		code: "corporate-administration.company-identifier.manage",
		module: "corporate-administration",
		description: "Manage legal company identifiers",
		sensitive: true,
	},
	{
		code: "corporate-administration.governance.manage",
		module: "corporate-administration",
		description: "Manage governance and premises records",
		sensitive: true,
	},
	{
		code: "corporate-administration.governance.read",
		module: "corporate-administration",
		description: "Read governance and premises records",
		sensitive: false,
	},
	{
		code: "corporate-administration.share-capital.manage",
		module: "corporate-administration",
		description: "Manage share capital ledger and disclosures",
		sensitive: true,
	},
	{
		code: "corporate-administration.share-capital.read",
		module: "corporate-administration",
		description: "Read share capital ledger and holdings",
		sensitive: false,
	},
	{
		code: "corporate-administration.property-assets.manage",
		module: "corporate-administration",
		description: "Manage property and corporate asset registers",
		sensitive: true,
	},
	{
		code: "corporate-administration.property-assets.read",
		module: "corporate-administration",
		description: "Read property and corporate asset registers",
		sensitive: false,
	},
	{
		code: "corporate-administration.licences-banking.manage",
		module: "corporate-administration",
		description: "Manage licences, banking registrations, and group control",
		sensitive: true,
	},
	{
		code: "corporate-administration.licences-banking.read",
		module: "corporate-administration",
		description: "Read licences, banking registrations, and group control",
		sensitive: false,
	},
	{
		code: "corporate-administration.documents-filings.manage",
		module: "corporate-administration",
		description: "Manage corporate documents and filing obligations",
		sensitive: true,
	},
	{
		code: "corporate-administration.documents-filings.read",
		module: "corporate-administration",
		description: "Read corporate documents and filing obligations",
		sensitive: false,
	},
	{
		code: "corporate-administration.compliance.read",
		module: "corporate-administration",
		description: "Read compliance search and due/overdue filing queries",
		sensitive: false,
	},
] as const;
