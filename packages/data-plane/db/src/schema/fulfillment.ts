...
export const delivery = pgTable(
	"delivery",
	{
		...
		packIdempotencyKey: text("pack_idempotency_key"),
		pickStartIdempotencyKey: text("pick_start_idempotency_key"),
		podIdempotencyKey: text("pod_idempotency_key"),
...
export const deliveryPick = pgTable(
	"delivery_pick",
	{
		...
		pickIdempotencyKey: text("pick_idempotency_key"),
