        ...
        <div className='flex w-full flex-col gap-6 p-6 sm:max-w-lg'>
          ...
          <div>
            ...
            <p className='text-muted-foreground'>
              ...
              <span className='text-foreground font-semibold'>johndoe@gmail.com</span>, Please follow thee link inside
              to continue.
            </p>
          </div>
        ...
        <Card className='relative h-full justify-between overflow-hidden border-none py-8'>
          ...
          <CardHeader className='relative z-10 gap-6 px-8'>
            ...
            <p className='text-xl text-white'>
              Thank you for signing up! To complete your registration and secure your account, we need to verify your
              email address.
            </p>
          </CardHeader>
          ...
          <CardContent className='relative z-10 mx-8 h-62 overflow-hidden rounded-2xl px-0'>
            ...
            <div className='flex flex-col gap-5 p-6 text-black'>
              <p className='line-clamp-2 pr-12 text-3xl font-bold'>Verify Your Email Address</p>
              <p className='line-clamp-2 text-lg'>
                Verifying your email helps us keep your account secure and ensures you won&apos;t miss important
                updates.
              </p>
