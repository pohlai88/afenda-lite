...
export const db: ChatData = {
	currentUser: {
		...
		status: "online",
		about:
			"Building great admin experiences and leading the platform team at WebLabs Studio.",
	...
	contacts: [
		...
		},
		{
			...
			socialLinks: [
				{ platform: "linkedin", url: "https://linkedin.com/in/davidpark" },
			],
		},
		{
			id: "contact-5",
			...
			socialLinks: [
				{
					platform: "linkedin",
					url: "https://linkedin.com/in/jessicamartinez",
				},
			],
		},
		{
			...
			socialLinks: [
				{ platform: "linkedin", url: "https://linkedin.com/in/alexthompson" },
			],
		},
		{
			id: "contact-7",
			...
			tags: ["HR", "Culture"],
			socialLinks: [
				{ platform: "linkedin", url: "https://linkedin.com/in/lisanguyen" },
			],
		},
		{
			id: "contact-8",
		...
		},
		{
			...
			tags: ["Support", "CS"],
			socialLinks: [
				{ platform: "linkedin", url: "https://linkedin.com/in/norakim" },
			],
		},
		{
			id: "contact-12",
			...
			socialLinks: [
				{ platform: "linkedin", url: "https://linkedin.com/in/tombradley" },
			],
		},
	],
	conversations: [
			...
			messages: [
				{
					...
					senderId: "contact-1",
					content:
						"Hi John, do you have a moment to review the Q1 marketing deck?",
					type: "text",
				...
				},
				{
					...
					content:
						"Sure Sarah — send it over and I will take a look this afternoon.",
					type: "text",
				...
				},
				{
					...
					senderId: "contact-1",
					content:
						"Here is the latest version with your feedback incorporated.",
					type: "file",
			...
			messages: [
				{
					...
					senderId: "contact-2",
					content:
						"Quick update — dashboard Phase 1 is on track for end of month.",
					type: "text",
		...
		},
		{
			...
			unreadCount: 1,
			suggestions: [
				"Love the new mockups!",
				"Can we iterate on the sidebar?",
				"Looks ready for dev.",
			],
			autoReplies: [
		...
		},
		{
			...
			messages: [
				...
				},
				{
					...
					senderId: "contact-4",
					content:
						"OAuth2 flow + unit tests are in — link is in the PR description.",
					type: "text",
		...
		},
		{
			...
			unreadCount: 0,
			suggestions: [
				"Maintenance window works for me.",
				"I will monitor the deploy.",
		...
		},
		{
			...
			messages: [
				...
				},
				{
					...
					senderId: CURRENT_USER_ID,
					content:
						"Thanks Jessica — I will review the marketing line items today.",
					type: "text",
			...
			messages: [
				{
					...
					senderId: "contact-6",
					content:
						"Staging deploy finished — here is the dashboard screenshot.",
					type: "image",
			...
			messages: [
				{
					...
					senderId: "contact-7",
					content:
						"Hi John — updated the [employee handbook](#) with the remote work policy.",
					type: "text",
				...
				},
				{
					...
					senderId: CURRENT_USER_ID,
					content:
						"**Great timing** — we have three new hires starting next week.",
					type: "text",
				...
				},
				{
					...
					senderId: "contact-7",
					content:
						"Team offsite survey closes tomorrow — reminder to share with leads.",
					type: "text",
			...
			messages: [
				{
					...
					senderId: "contact-8",
					content:
						"CI pipeline failed on the auth service build — logs attached.",
					type: "file",
		...
		},
		{
			...
			messages: [
				...
				},
				{
					...
					senderId: "contact-11",
					content:
						"Customers asked for clearer attachment previews — this helps.",
					type: "text",
				...
				},
				{
					...
					senderId: CURRENT_USER_ID,
					content:
						"Can we align the toolbar icons with the mail compose pattern?",
					type: "text",
		...
		},
		{
			...
			unreadCount: 1,
			suggestions: [
				"Let us sync on the demo.",
				"I will update the deck.",
				"Sounds good.",
			],
			autoReplies: [
			...
			messages: [
				{
					...
					senderId: "contact-10",
					content:
						"Enterprise prospect wants a live admin dashboard demo next week.",
					type: "text",
				...
				},
				{
					...
					senderId: "contact-1",
					content:
						"Campaign screenshot from last week — strong CTR on the chat feature highlight.",
					type: "image",
			...
			messages: [
				{
					...
					senderId: "contact-10",
					content:
						"Hi John — can you intro me to [legal](#) for the Acme contract review?",
					type: "text",
					timestamp: "2026-06-08T10:00:00.000Z",
					status: "read",
				},
				...
				},
				{
					...
					senderId: CURRENT_USER_ID,
					content:
						"Forwarded to product — Michael will send an updated version.",
					type: "text",
		...
		},
		{
			...
			messages: [
				...
				},
				{
					...
					senderId: "contact-12",
					content:
						"Legal review of vendor contracts is complete — summary attached.",
					type: "file",
				...
				},
				{
					...
					senderId: CURRENT_USER_ID,
					content:
						"I will cover the admin template roadmap and chat module status.",
					type: "text",
			...
			messages: [
				{
					...
					senderId: "contact-12",
					content:
						"Vendor SaaS agreement for your review — key terms highlighted.",
					type: "file",
					timestamp: "2026-06-07T09:00:00.000Z",
					status: "read",
					attachments: [
				...
				},
				{
					...
					senderId: CURRENT_USER_ID,
					content:
						"Question on the data processing addendum — is section 4 standard?",
					type: "text",
					timestamp: "2026-06-07T11:00:00.000Z",
					status: "read",
					replyToId: "msg-16-1",
